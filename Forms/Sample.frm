...
Begin VB.Form frmSample 
   ...
   Begin VB.Frame fra1 
      ...
      End
   End
   Begin VSFlex8Ctl.VSFlexGrid vsPayroll 
      Height          =   4095
      Left            =   975
      TabIndex        =   0
      Top             =   3045
...
Private Sub cmdGenerate_Click()
    ...
    If Trim(tdbPayrollPeriod.BoundText) = "" Or IsNull(tdbPayrollPeriod.SelectedItem) Or tdbPayrollPeriod.ApproxCount = 0 Then
    ...
    If Trim(tdbEmployee.Text) = "" Or IsNull(tdbEmployee.SelectedItem) Or tdbEmployee.ApproxCount = 0 Then
        mAddQuery = ""
    Else
        mAddQuery = " and x1.empno = '" & tdbEmployee.BoundText & "'"
    End If
    
    NetOpen rsTmp, "", "select x2.empno,concat(x2.lastname, ', ', x2.firstname,' ',x2.middlename) fullname,  x1.basic,x1.absamnt,x1.lateamnt,x1.utamnt,x1.earnings, " & _
            "(x1.otrstamnt+x1.otregamnt+x1.otspcamnt+x1.otlegamnt+x1.otnprstamnt+x1.otnpregamnt+x1.otnpspcamnt+x1.otnplegamnt) OT, " & _
            "x1.sssamnt,x1.philamnt,x1.hdmfamnt,x1.deductions,x1.loanded,x1.taxamnt,x1.net   from payroll x1 " & _
            "left outer join employee x2 on x1.empno = x2.empno " & _
            "where  x1.percode = '" & tdbPayrollPeriod.BoundText & "' " & mAddQuery & " order by concat(x2.lastname, ', ', x2.firstname,' ',x2.middlename) "
            
    Set vsPayroll.DataSource = rsTmp
