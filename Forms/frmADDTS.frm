...
Begin VB.Form frmADDTS 
   ...
   Begin VB.Frame fra1 
      ...
      End
      Begin TDBText6Ctl.TDBText txtTotalOT 
         Height          =   300
         Left            =   9975
         TabIndex        =   2
         Top             =   1110
         ...
         EndProperty
         DropDown        =   "frmADDTS.frx":0116
         Key             =   "frmADDTS.frx":0134
      ...
      Begin TDBText6Ctl.TDBText txtSearch 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmADDTS.frx":01E4
         Key             =   "frmADDTS.frx":0202
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   -2147483640
         ReadOnly        =   0
...
Public rsDts   As ADODB.Recordset
...
Private Sub tdbPayrollPeriod_LostFocus()
  If Not IsNull(tdbPayrollPeriod.SelectedItem) And Trim(tdbPayrollPeriod.Text) <> "" And tdbPayrollPeriod.ApproxCount > 0 Then
    NetOpen rsDts, "select x1.*,x2.costcenter,x3.division,x4.branch, " & _
                          "concat(x5.lastname,', ',x5.firstname,' ',x5.middlename) fullname from dtshdr x1 " & _
                          ...
                          "where x1.percode = '" & tdbPayrollPeriod.BoundText & "' order by x1.dtscode"
  
    Set tdgDTS.DataSource = rsDts
    Cancel_Clicked
  End If
End Sub
...
Private Sub txtSearch_KeyPress(KeyAscii As Integer)
  If KeyAscii = 13 Then
    SendKeys "{TAB}"
  Else
    SearchRecord KeyAscii, txtSearch, rsDts, txtSearch.Text, tdbSort.BoundText
  End If
End Sub
