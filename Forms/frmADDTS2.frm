...
Begin VB.Form frmADDTS2 
   ...
   Begin LinkProPayroll.b8ChildTitleBar TitleBar 
      ...
      FontSize        =   8.25
   End
   Begin TrueOleDBGrid80.TDBGrid tdgDTSLine 
      Height          =   3945
      Left            =   60
      TabIndex        =   0
      Top             =   1965
      ...
      Columns(4).Caption=   "Total Hrs"
      Columns(4).DataField=   "phrs"
      Columns(4).NumberFormat=   "#,##0.00"
      Columns(4)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(5)._VlistStyle=   0
      Columns(5)._MaxComboItems=   5
      Columns(5).Caption=   "Remarks"
      Columns(5).DataField=   "remarks"
      Columns(5).ExternalEditor=   "txtRemarks"
      ...
      Columns(6).DropDown=   "tddStatus"
      Columns(6).DropDown.vt=   8
      Columns(6).ExternalEditor=   "txtStatus"
      Columns(6).ExternalEditor.vt=   8
      Columns(6)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(7)._VlistStyle=   0
      Columns(7)._MaxComboItems=   5
      Columns(7).Caption=   "Approved By"
      Columns(7).DataField=   "approvby"
      Columns(7).DropDown=   "tddSignatory"
      Columns(7).DropDown.vt=   8
      Columns(7).ExternalEditor=   "txtSignatory"
      Columns(7).ExternalEditor.vt=   8
      Columns(7)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(8)._VlistStyle=   0
      Columns(8)._MaxComboItems=   5
      Columns(8).Caption=   "enteredbyuser"
      Columns(8).DataField=   "enteredbyuser"
      ...
      Splits(0)._ColumnProps(23)=   "Column(4).Width=1799"
      Splits(0)._ColumnProps(24)=   "Column(4).DividerColor=0"
      Splits(0)._ColumnProps(25)=   "Column(4)._WidthInPix=1720"
      Splits(0)._ColumnProps(26)=   "Column(4)._EditAlways=0"
      Splits(0)._ColumnProps(27)=   "Column(4)._ColStyle=8196"
      Splits(0)._ColumnProps(28)=   "Column(4).Order=5"
      Splits(0)._ColumnProps(29)=   "Column(5).Width=3281"
      Splits(0)._ColumnProps(30)=   "Column(5).DividerColor=0"
      Splits(0)._ColumnProps(31)=   "Column(5)._WidthInPix=3201"
      ...
      Splits(0)._ColumnProps(48)=   "Column(8)._ColStyle=8196"
      ...
      _StyleDefs(50)  =   "Splits(0).Columns(4).Style:id=50,.parent=13,.locked=-1"
      ...
      _StyleDefs(62)  =   "Splits(0).Columns(7).Style:id=58,.parent=13"
      ...
      _StyleDefs(66)  =   "Splits(0).Columns(8).Style:id=70,.parent=13,.locked=-1"
   ...
   Begin TDBTime6Ctl.TDBTime txtTime 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Keys            =   "frmADDTS2.frx":006C
      Spin            =   "frmADDTS2.frx":00BC
      AlignHorizontal =   0
      AlignVertical   =   0
      Appearance      =   0
   ...
   Begin TDBDate6Ctl.TDBDate txtWrkdate 
      ...
      _ExtentX        =   2514
      _ExtentY        =   503
      Calendar        =   "frmADDTS2.frx":00E4
      Caption         =   "frmADDTS2.frx":01FC
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmADDTS2.frx":0268
      Keys            =   "frmADDTS2.frx":0286
      Spin            =   "frmADDTS2.frx":02E4
      AlignHorizontal =   0
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   -2147483643
   ...
   Begin TDBText6Ctl.TDBText txtRemarks 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmADDTS2.frx":0378
      Key             =   "frmADDTS2.frx":0396
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   -1
   ...
   Begin TDBText6Ctl.TDBText txtStatus 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmADDTS2.frx":0446
      Key             =   "frmADDTS2.frx":0464
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   -1
   ...
   Begin TDBText6Ctl.TDBText txtSignatory 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmADDTS2.frx":0514
      Key             =   "frmADDTS2.frx":0532
      BackColor       =   -2147483643
      EditMode        =   0
      ForeColor       =   -2147483640
      ReadOnly        =   -1
   ...
   Begin VB.Frame fra1 
      ...
      Begin TDBText6Ctl.TDBText txtCostCenter 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmADDTS2.frx":05E2
         Key             =   "frmADDTS2.frx":0600
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   -2147483640
         ReadOnly        =   -1
      ...
      Begin TDBText6Ctl.TDBText txtDivision 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmADDTS2.frx":06B0
         Key             =   "frmADDTS2.frx":06CE
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   -2147483640
         ReadOnly        =   -1
      ...
      Begin TDBText6Ctl.TDBText txtBranch 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmADDTS2.frx":077E
         Key             =   "frmADDTS2.frx":079C
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   -2147483640
         ReadOnly        =   -1
      ...
      End
      Begin TDBText6Ctl.TDBText txtDTSCode 
         Height          =   300
         Left            =   1755
         TabIndex        =   11
         Top             =   330
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmADDTS2.frx":09A0
         Key             =   "frmADDTS2.frx":09BE
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   -2147483640
         ReadOnly        =   -1
   ...
   Begin TDBNumber6Ctl.TDBNumber txtTotal 
      ...
      _ExtentX        =   3545
      _ExtentY        =   503
      Calculator      =   "frmADDTS2.frx":0A02
      Caption         =   "frmADDTS2.frx":0A22
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Century Gothic"
         Size            =   8.25
         Charset         =   0
         ...
         Strikethrough   =   0   'False
      EndProperty
      DropDown        =   "frmADDTS2.frx":0A8E
      Keys            =   "frmADDTS2.frx":0AAC
      Spin            =   "frmADDTS2.frx":0AF6
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   -2147483643
      ...
      ValueVT         =   1245189
      Value           =   0
      MaxValueVT      =   1448869893
      MinValueVT      =   1952841733
   End
...
Dim rsTempDTSEntry  As ADODB.Recordset
...
Private Sub Form_Load()
  ...
  bind_tdb ConMain, tdbEmpNo, "select employeecode,employeecode from employee " & _
                            "where payfreqcode = '" & frmADDTS.tdbPayrollPeriod.Columns("payfreqcode").Text & "' " & _
                            "order by employeecode", "employeecode", "employeecode"
  ...
  bind_tdb ConMain, tdbEmpName, "select x1.employeecode,concat(x1.lastname,' ',x1.firstname,' ',x1.middlename) fullname, " & _
                          ...
                          "where payfreqcode = '" & frmADDTS.tdbPayrollPeriod.Columns("payfreqcode").Text & "' " & _
                          "order by concat(x1.lastname,' ',x1.firstname,' ',x1.middlename)", "fullname", "employeecode"
...
Private Sub cmdSave_Click()
    ...
    Dim mdtscode     As String
    Dim mPerCode    As String
    Dim mDate       As String
    Dim mEntrdBU    As String
    Dim mdtslneno    As String
    ...
    If mAdd = True Then
        ...
        If isEmpExists(tdbEmpNo.Text) = True Then
            MsgBox "Employee has already an existing overime entry.", vbExclamation + vbOKOnly
            ConMain.RollbackTrans
            Exit Sub
        End If
    
        txtDTSCode.Text = LastCode("dtshdr")
        
        ConMain.Execute "insert into dtshdr(dtscode,employeecode,percode,costcentercode,divisioncode,branchcode,payyear,paymonth,tdatetime) values " & _
                              "('" & txtDTSCode.Text & "','" & tdbEmpNo.Text & "','" & frmADDTS.tdbPayrollPeriod.Columns("percode").Text & "', " & _
                              "'" & tdbEmpName.Columns("costcentercode").Text & "', " & _
                              "'" & tdbEmpName.Columns("divisioncode").Text & "','" & tdbEmpName.Columns("branchcode").Text & "', " & _
                              "'" & frmADDTS.tdbPayrollPeriod.Columns("payyear").Text & "', " & _
                              "'" & frmADDTS.tdbPayrollPeriod.Columns("paymonth").Text & "',now())"
    End If
    
    ConMain.Execute "delete from dtslne where employeecode = '" & tdbEmpNo.Text & "' and fnlz = 'N' and percode = '" & frmADDTS.tdbPayrollPeriod.Columns("percode").Text & "'"
    ...
    With rsTempDTSEntry
        ...
        If !Status <> "Pending" Then
            mdtscode = txtDTSCode.Text
            mPerCode = frmADDTS.tdbPayrollPeriod.Columns("percode").Text
        Else
            mdtscode = ""
            mPerCode = ""
        End If
        ...
        If Trim(!dtslneno) = "" Then
            mdtslneno = LastCode("dtslne")
        Else
            mdtslneno = !dtslneno
        End If
        
        ConMain.Execute "insert into dtslne(dtslneno,employeecode,dtscode,percode,wrkdate,approvby, " & _
                              "remarks,pstart,pend,phrs, " & _
                              "status,tdatetime,enteredbyuser,fnlz) values " & _
                              "('" & mdtslneno & "','" & tdbEmpNo.Text & "','" & mdtscode & "','" & mPerCode & "','" & Format(!wrkdate, "YYYY-MM-DD") & "','" & !approvby & "', " & _
                              "'" & !remarks & "','" & Format(!pstart, "hh:nn") & "','" & Format(!pend, "hh:nn") & "'," & !phrs & ", " & _
    ...
    frmADDTS.rsDts.Requery
    frmADDTS.rsDts.Find "dtscode = '" & txtDTSCode.Text & "'"
    Lock_Button "TTFFTT", frmADDTS.cmdMenu, 5
...
Private Sub tdbEmpName_LostFocus()
    If tdbEmpName.ApproxCount > 0 And Trim(tdbEmpName.Text) <> "" And Not IsNull(tdbEmpName.SelectedItem) Then
        ...
        If isEmpExists(tdbEmpName.BoundText) = False Then
            If tdbEmpName.Tag <> tdbEmpNo.BoundText Then
    ...
    Else
        tdbEmpNo.BoundText = ""
        Set tdgDTSLine.DataSource = Nothing
    End If
End Sub
...
Private Sub tdgDTSLine_AfterColUpdate(ByVal ColIndex As Integer)
    With tdgDTSLine
        If ColIndex = .Columns("pstart").ColIndex Or ColIndex = .Columns("pend").ColIndex Then
            GetTtlHrs
        End If
    End With
End Sub

Private Sub tdgDTSLine_BeforeColEdit(ByVal ColIndex As Integer, ByVal KeyAscii As Integer, Cancel As Integer)

'  If ColIndex = 2 Or ColIndex = 3 Or ColIndex = 4 Then
'    If tdgDTSLine.Columns("leavetypescode").Text = "" Then Cancel = True
'    If ColIndex = 3 Then
'      If tdgDTSLine.Columns("secondshift").Value = 0 Then Cancel = True
'    End If
'    If ColIndex = 4 Then
'      If tdgDTSLine.Columns("firstshift").Value = 0 Then Cancel = True
'    End If
'  End If

End Sub

Private Sub tdgDTSLine_BeforeColUpdate(ByVal ColIndex As Integer, OldValue As Variant, Cancel As Integer)
  
    With tdgDTSLine
        If ColIndex = .Columns("pstart").ColIndex Or ColIndex = .Columns("pend").ColIndex Then
            If IsDate(.Columns("wrkdate").Text) Then
                .Columns("phrs").Text = TtlHrs(.Columns("wrkdate").Text & " " & .Columns("pstart").Text, .Columns("wrkdate").Text & " " & .Columns("pend").Text)
            End If
...
Private Sub tdgDTSLine_BeforeRowColChange(Cancel As Integer)

'  If tdgDTSLine.Columns("leavetypescode").Text <> "" Then
'
'    If tdgDTSLine.Columns("leavetypes").Text = "" Then
'      Cancel = True
'      tdgDTSLine.Col = tdgDTSLine.Columns("leavetypes").ColIndex
'      SendKeys " "
'      Exit Sub
'    End If

'    If tdgDTSLine.Columns("lvdate").Text = "" Then
'      Cancel = True
'      tdgDTSLine.Col = tdgDTSLine.Columns("lvdate").ColIndex
'      Exit Sub
'    End If

'    If tdgDTSLine.Columns("firstshift").Value = 0 And tdgDTSLine.Columns("secondshift").Value = 0 Then
'      tdgDTSLine.Columns("firstshift").Value = 1
'      tdgDTSLine.Columns("secondshift").Value = 1
'    End If
'
'  End If
...
Private Sub tdgDTSLine_Error(ByVal DataError As Integer, Response As Integer)
    Response = False
End Sub

Private Sub tdgDTSLine_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = 46 Then
        If txtWrkdate.Visible = False Then
            With tdgDTSLine
                If rsTempDTSEntry.RecordCount > 0 Then
                    .Update
                    If Not .EOF And Not .BOF Then
                      If Trim(.Columns("dtslneno").Text) = "" Then
                        .Delete
                      End If
                    End If
                End If
...
Private Sub tddSignatory_DropDownOpen()
    With tddSignatory
        .Width = tdgDTSLine.Width - tdgDTSLine.Columns("approvby").Left
    End With
...
Private Sub tddStatus_DropDownOpen()
    With tddStatus
        .Width = tdgDTSLine.Columns("status").Width
    End With
End Sub
...
Private Sub Create_TmpOTEntry()
    ...
    If Not rsTempDTSEntry Is Nothing Then
        If rsTempDTSEntry.RecordCount > 0 Then
            rsTempDTSEntry.MoveFirst
            Do While Not rsTempDTSEntry.EOF
                rsTempDTSEntry.Delete
                rsTempDTSEntry.Update
                If rsTempDTSEntry.RecordCount > 0 Then
                    rsTempDTSEntry.MoveFirst
                Else
                    Exit Do
    ...
    Set rsTempDTSEntry = Nothing
    Set rsTempDTSEntry = New ADODB.Recordset
    
    With rsTempDTSEntry
        .Fields.Append "dtslneno", adVarChar, 7
        .Fields.Append "dtscode", adVarChar, 7
        ...
        .Fields.Append "pstart", adVarChar, 11
        .Fields.Append "pend", adVarChar, 11
        .Fields.Append "phrs", adDouble, 18
        .Fields.Append "status", adVarChar, 20
        .Fields.Append "enteredbyuser", adVarChar, 1
        .Fields.Append "tdatetime", adVarChar, 20
        .Open
    End With
    Set tdgDTSLine.DataSource = rsTempDTSEntry
...
Private Sub Load_OT(mEmpNo As String)
    ...
    NetOpen rsOTEntry, "select * from dtslne where employeecode = '" & mEmpNo & "' and fnlz = 'N' and percode = '" & frmADDTS.tdbPayrollPeriod.Columns("percode").Text & "' "

    With rsOTEntry
        If .RecordCount > 0 Then
          .MoveFirst
          Do While Not .EOF
            rsTempDTSEntry.AddNew
            rsTempDTSEntry.Fields("dtslneno") = !dtslneno
            rsTempDTSEntry.Fields("dtscode") = !dtscode
            rsTempDTSEntry.Fields("percode") = !percode
            rsTempDTSEntry.Fields("wrkdate") = !wrkdate
            rsTempDTSEntry.Fields("approvby") = !approvby
            rsTempDTSEntry.Fields("remarks") = !remarks
            rsTempDTSEntry.Fields("pstart") = !pstart
            rsTempDTSEntry.Fields("pend") = !pend
            rsTempDTSEntry.Fields("phrs") = !phrs
            rsTempDTSEntry.Fields("status") = !Status
            rsTempDTSEntry.Fields("enteredbyuser") = !enteredbyuser
            rsTempDTSEntry.Fields("tdatetime") = Format(!tdatetime, "YYYY-MM-DD hh:nn:ss")
            rsTempDTSEntry.Update
            .MoveNext
          Loop
        End If
...
Private Function isEmpExists(mEmpNo As String) As Boolean
    ...
    With rsTmpOT
        Set rsTmpOT.DataSource = frmADDTS.rsDts.Clone
        If .RecordCount > 0 Then
            .MoveFirst
...
Private Sub txtWrkdate_Keypress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        tdgDTSLine.SetFocus
    End If
End Sub
...
Private Sub GetTtlHrs()
    Dim rsTmp       As ADODB.Recordset
    Set rsTmp = New ADODB.Recordset
    
    Set rsTmp.DataSource = rsTempDTSEntry.Clone
    ...
    With rsTmp
        If .RecordCount > 0 Then
            ...
            .MoveFirst
            Do While Not .EOF
                txtTotal.Text = Format(CDbl(txtTotal.Text) + CDbl(!phrs), "#,##0.00")
                .MoveNext
            Loop
        End If
    End With
