...
Begin VB.Form frmADEarnings 
   ...
   Begin VB.Frame fra1 
      ...
      Begin TDBText6Ctl.TDBText txtSearch 
         ...
         _ExtentX        =   6853
         _ExtentY        =   529
         Caption         =   "frmADEarnings.frx":6852
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmADEarnings.frx":68BE
         Key             =   "frmADEarnings.frx":68DC
      ...
      Begin TrueOleDBList80.TDBCombo tdbPayrollPeriod 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmADEarnings.frx":6920
      ...
      Begin TrueOleDBList80.TDBCombo tdbSort 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmADEarnings.frx":69CA
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      End
   End
   Begin TrueOleDBGrid80.TDBGrid tdgEarnings 
      Height          =   2550
      Left            =   45
      TabIndex        =   0
      Top             =   2910
      ...
      Columns(2)._VlistStyle=   0
      Columns(2)._MaxComboItems=   5
      Columns(2).Caption=   "Other Earnings"
      Columns(2).DataField=   "otherearnings"
      Columns(2)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(3)._VlistStyle=   0
      Columns(3)._MaxComboItems=   5
      ...
      Columns(4)._VlistStyle=   0
      Columns(4)._MaxComboItems=   5
      Columns(4).Caption=   "Cost Center"
      Columns(4).DataField=   "costcenter"
      Columns(4)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(5)._VlistStyle=   0
      Columns(5)._MaxComboItems=   5
      Columns(5).Caption=   "Division"
      Columns(5).DataField=   "division"
      Columns(5)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(6)._VlistStyle=   0
      Columns(6)._MaxComboItems=   5
      Columns(6).Caption=   "Branch"
      Columns(6).DataField=   "branch"
      Columns(6)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(7)._VlistStyle=   0
      Columns(7)._MaxComboItems=   5
      Columns(7).Caption=   "Remarks"
      Columns(7).DataField=   "remarks"
      ...
      _StyleDefs(8)   =   ":id=1,.fontname=Arial"
      _StyleDefs(9)   =   "CaptionStyle:id=4,.parent=2,.namedParent=37"
      _StyleDefs(10)  =   "HeadingStyle:id=2,.parent=1,.namedParent=34,.bgcolor=&HF6F8F8&,.fgcolor=&H0&"
      _StyleDefs(11)  =   "FooterStyle:id=3,.parent=1,.namedParent=35"
      _StyleDefs(12)  =   "InactiveStyle:id=5,.parent=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(13)  =   "SelectedStyle:id=6,.parent=1,.namedParent=36"
      _StyleDefs(14)  =   "EditorStyle:id=7,.parent=1"
      _StyleDefs(15)  =   "HighlightRowStyle:id=8,.parent=1,.namedParent=38,.bgcolor=&H6FE0FD&"
      _StyleDefs(16)  =   ":id=8,.fgcolor=&H0&"
      _StyleDefs(17)  =   "EvenRowStyle:id=9,.parent=1,.namedParent=39,.bgcolor=&HFFF0EA&"
      _StyleDefs(18)  =   "OddRowStyle:id=10,.parent=1,.namedParent=33"
      _StyleDefs(19)  =   "RecordSelectorStyle:id=11,.parent=2,.namedParent=41,.bgcolor=&HF6F8F8&"
      ...
      _StyleDefs(33)  =   "Splits(0).Columns(0).Style:id=78,.parent=13,.locked=-1"
      _StyleDefs(34)  =   "Splits(0).Columns(0).HeadingStyle:id=75,.parent=14"
      _StyleDefs(35)  =   "Splits(0).Columns(0).FooterStyle:id=76,.parent=15"
      _StyleDefs(36)  =   "Splits(0).Columns(0).EditorStyle:id=77,.parent=17"
      ...
      _StyleDefs(45)  =   "Splits(0).Columns(3).Style:id=46,.parent=13"
      ...
      _StyleDefs(49)  =   "Splits(0).Columns(4).Style:id=50,.parent=13"
      ...
      _StyleDefs(53)  =   "Splits(0).Columns(5).Style:id=54,.parent=13"
      _StyleDefs(54)  =   "Splits(0).Columns(5).HeadingStyle:id=51,.parent=14"
      _StyleDefs(55)  =   "Splits(0).Columns(5).FooterStyle:id=52,.parent=15"
      _StyleDefs(56)  =   "Splits(0).Columns(5).EditorStyle:id=53,.parent=17"
      _StyleDefs(57)  =   "Splits(0).Columns(6).Style:id=58,.parent=13"
      ...
      _StyleDefs(61)  =   "Splits(0).Columns(7).Style:id=62,.parent=13"
      ...
      _StyleDefs(77)  =   ":id=38,.parent=33,.bgcolor=&HFAE4AB&,.fgcolor=&H0&"
   ...
   End
End
Attribute VB_Name = "frmADEarnings"
...
Public rsEarnings   As ADODB.Recordset
  ...
  Select Case Index
    Case 0:
          If Trim(tdbPayrollPeriod.Text) <> "" And Not IsNull(tdbPayrollPeriod.SelectedItem) And tdbPayrollPeriod.ApproxCount > 0 Then
            frmADEarnings2.mAdd = True
            frmADEarnings2.Show vbModal
          Else
...
Private Sub Form_Load()
    ...
    bind_tdb CitronPayroll, tdbPayrollPeriod, "select percode, description, wrkdatefrom, wrkdateto,payyear,paymonth from payrollperiod order by description", "description", "percode"
    ...
    With rsTMP
      For I = 1 To 6
        .AddNew
        Select Case I
          Case 1: .Fields("code") = "empno"
                  .Fields("description") = "Employee Number"
          Case 2: .Fields("code") = "fullname"
                  .Fields("description") = "Fullname"
          Case 3: .Fields("code") = "otherearnings"
                  .Fields("description") = "Other Earnings"
          Case 4: .Fields("code") = "costcenter"
                  .Fields("description") = "Cost Center"
          Case 5: .Fields("code") = "division"
                  .Fields("description") = "Division"
          Case 6: .Fields("code") = "branch"
...
Private Sub Cancel_Clicked()
  If rsEarnings.RecordCount > 0 Then
...
Private Sub tdbPayrollPeriod_LostFocus()
  If Not IsNull(tdbPayrollPeriod.SelectedItem) And Trim(tdbPayrollPeriod.Text) <> "" And tdbPayrollPeriod.ApproxCount > 0 Then
    NetOpen rsEarnings, "", "select x1.*,x2.costcenter,x3.division,x4.branch,x6.otherearnings, " & _
                          "concat(x5.lastname,', ',x5.firstname,' ',x5.middlename) fullname from earnings x1  " & _
                          ...
                          "left outer join employee x5 on x1.empno = x5.empno " & _
                          "left outer join otherearnings x6 on x1.otherearningscode = x6.otherearningscode " & _
                          "where x1.percode = '" & tdbPayrollPeriod.BoundText & "' order by x1.percode"
  
    Set tdgEarnings.DataSource = rsEarnings
    Cancel_Clicked
  End If
End Sub

Private Sub tdbPayrollPeriod_ItemChange()
  Set rsEarnings = Nothing
  Set tdgEarnings.DataSource = Nothing
...
Private Sub tdbSort_ItemChange()
  rsEarnings.Sort = tdbSort.BoundText
End Sub
...
Private Sub txtsearch_KeyPress(KeyAscii As Integer)
  If KeyAscii = 13 Then
    SendKeys "{TAB}"
  Else
    SearchRecord KeyAscii, txtSearch, rsEarnings, tdbSort.BoundText, tdbSort.BoundText
  End If
End Sub
