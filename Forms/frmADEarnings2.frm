...
Begin VB.Form frmADEarnings2 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin TDBText6Ctl.TDBText txtCostCenter 
         ...
         _ExtentX        =   7064
         _ExtentY        =   529
         Caption         =   "frmADEarnings2.frx":6852
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmADEarnings2.frx":68BE
         Key             =   "frmADEarnings2.frx":68DC
      ...
      Begin TDBText6Ctl.TDBText txtRemarks 
         ...
         _ExtentX        =   7064
         _ExtentY        =   1058
         Caption         =   "frmADEarnings2.frx":6920
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmADEarnings2.frx":698C
         Key             =   "frmADEarnings2.frx":69AA
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   -2147483640
         ReadOnly        =   0
      ...
      Begin TDBText6Ctl.TDBText txtDivision 
         ...
         _ExtentX        =   7064
         _ExtentY        =   529
         Caption         =   "frmADEarnings2.frx":69EE
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmADEarnings2.frx":6A5A
         Key             =   "frmADEarnings2.frx":6A78
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   -2147483640
         ReadOnly        =   0
      ...
      Begin TDBText6Ctl.TDBText txtBranch 
         ...
         _ExtentX        =   7064
         _ExtentY        =   529
         Caption         =   "frmADEarnings2.frx":6ABC
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmADEarnings2.frx":6B28
         Key             =   "frmADEarnings2.frx":6B46
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   -2147483640
         ReadOnly        =   0
         ...
         OLEDropMode     =   0
      End
      Begin TDBText6Ctl.TDBText txtEarncode 
         Height          =   300
         Left            =   1920
         TabIndex        =   5
         Top             =   255
         ...
         _ExtentX        =   4419
         _ExtentY        =   529
         Caption         =   "frmADEarnings2.frx":6B8A
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmADEarnings2.frx":6BF6
         Key             =   "frmADEarnings2.frx":6C14
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   -2147483640
         ReadOnly        =   -1
      ...
      Begin TDBNumber6Ctl.TDBNumber txtAmount 
         ...
         _ExtentX        =   2646
         _ExtentY        =   556
         Calculator      =   "frmADEarnings2.frx":6C58
         Caption         =   "frmADEarnings2.frx":6C78
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmADEarnings2.frx":6CE4
         Keys            =   "frmADEarnings2.frx":6D02
         Spin            =   "frmADEarnings2.frx":6D4C
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   0
         BackColor       =   -2147483643
      ...
      Begin TrueOleDBList80.TDBCombo tdbEmpNo 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmADEarnings2.frx":6D74
      ...
      Begin TrueOleDBList80.TDBCombo tdbEmpName 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmADEarnings2.frx":6E1E
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      End
      Begin TrueOleDBList80.TDBCombo tdbEarnings 
         Height          =   345
         Left            =   1920
         TabIndex        =   9
         Tag             =   "Municipal"
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmADEarnings2.frx":6EC8
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
   ...
   End
End
Attribute VB_Name = "frmADEarnings2"
...
Private Sub cmdSave_Click()
  ...
  If Trim(tdbEarnings.Text) = "" Or IsNull(tdbEarnings.SelectedItem) Or tdbEarnings.ApproxCount = 0 Then
    MsgBox "Please select an earnings type.", vbExclamation + vbOKOnly
    tdbEarnings.SetFocus
    Exit Sub
  End If
  ...
  If mAdd = True Then
    ...
    txtEarncode.Text = LastCode("GetLastCodeA", "Earnings", "0000000")
    
    CitronPayroll.Execute "insert into earnings (earncode,otherearningscode,percode,empno,costcentercode, " & _
                          "divisioncode,branchcode,payyear,paymonth,amount,remarks) values ('" & txtEarncode.Text & "', " & _
                          "'" & tdbEarnings.BoundText & "','" & frmADEarnings.tdbPayrollPeriod.BoundText & "','" & tdbEmpName.BoundText & "', " & _
                          "'" & tdbEmpName.Columns("costcentercode").Text & "','" & tdbEmpName.Columns("divisioncode").Text & "', " & _
                          "'" & tdbEmpName.Columns("branchcode").Text & "', " & _
                          "'" & frmADEarnings.tdbPayrollPeriod.Columns("payyear").Text & "','" & frmADEarnings.tdbPayrollPeriod.Columns("paymonth").Text & "','" & CDbl(txtAmount.Text) & "','" & txtRemarks.Text & "')"
  ...
  Else
    ...
    CitronPayroll.Execute "update earnings set otherearningscode = '" & tdbEarnings.BoundText & "', percode = '" & frmADEarnings.tdbPayrollPeriod.BoundText & "', empno = '" & tdbEmpName.BoundText & "', " & _
                          "costcentercode = '" & tdbEmpName.Columns("costcentercode").Text & "',divisioncode = '" & tdbEmpName.Columns("divisioncode").Text & "', " & _
                          "branchcode = '" & tdbEmpName.Columns("branchcode").Text & "', payyear = '" & frmADEarnings.tdbPayrollPeriod.Columns("payyear").Text & "', " & _
                          "paymonth = '" & frmADEarnings.tdbPayrollPeriod.Columns("paymonth").Text & "',amount = '" & CDbl(txtAmount.Text) & "',remarks = '" & txtRemarks.Text & "' where earncode = '" & txtEarncode.Text & "'"
  
    CitronPayroll.CommitTrans
    
  End If
  
  frmADEarnings.rsEarnings.Requery
  frmADEarnings.rsEarnings.Find "earncode = '" & txtEarncode.Text & "'"
  Lock_Button "TTFFTT", frmADEarnings.cmdMenu, 5
...
Private Sub Form_Load()
  ...
  bind_tdb CitronPayroll, tdbEmpNo, "select empno,dummycode from employee order by dummycode", "dummycode", "empno"
  ...
  bind_tdb CitronPayroll, tdbEmpName, "select x1.empno,concat(x1.lastname,', ',x1.firstname,' ',x1.middlename) fullname, " & _
                          ...
                          "left outer join branch x4 on x1.branchcode = x4.branchcode order by x1.lastname,x1.firstname,x1.middlename", "fullname", "empno"
                          
  bind_tdb CitronPayroll, tdbEarnings, "select otherearningscode, otherearnings from otherearnings order by otherearnings", "otherearnings", "otherearningscode"
                          
  
  If mAdd = False Then
    With frmADEarnings.rsEarnings
      If .RecordCount > 0 Then
        txtEarncode.Text = !earncode
        ...
        tdbEarnings.BoundText = !OtherEarningscode
      End If
    End With
  End If
...
Private Sub tdbEarnings_Keypress(KeyAscii As Integer)
  If KeyAscii = 13 Then
    SendKeys "{TAB}"
  Else
    SearchList KeyAscii, tdbEarnings, tdbEarnings.RowSource, tdbEarnings.Text
  End If
End Sub
