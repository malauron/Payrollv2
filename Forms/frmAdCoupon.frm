...
Begin VB.Form frmAdCoupon 
   ...
   Begin VB.Frame fra1 
      ...
      Begin TrueOleDBList80.TDBCombo tdbValidityPeriod 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmAdCoupon.frx":0000
      ...
      Begin TDBText6Ctl.TDBText txtSearch 
         ...
         EndProperty
         DropDown        =   "frmAdCoupon.frx":0116
         Key             =   "frmAdCoupon.frx":0134
      ...
      Begin TrueOleDBList80.TDBCombo tdbSort 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmAdCoupon.frx":0178
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
   ...
   Begin VB.Frame fraButtons 
      ...
      Begin TDBNumber6Ctl.TDBNumber txtTotal 
         ...
         _ExtentX        =   3889
         _ExtentY        =   556
         Calculator      =   "frmAdCoupon.frx":0222
         Caption         =   "frmAdCoupon.frx":0242
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmAdCoupon.frx":02AE
         Keys            =   "frmAdCoupon.frx":02CC
         Spin            =   "frmAdCoupon.frx":0316
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   0
         BackColor       =   -2147483643
      ...
      Begin TDBNumber6Ctl.TDBNumber txtNoOfRecords 
         ...
         _ExtentX        =   2963
         _ExtentY        =   556
         Calculator      =   "frmAdCoupon.frx":033E
         Caption         =   "frmAdCoupon.frx":035E
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmAdCoupon.frx":03CA
         Keys            =   "frmAdCoupon.frx":03E8
         Spin            =   "frmAdCoupon.frx":0432
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   0
         BackColor       =   -2147483643
