...
Begin VB.Form frmAdNonTaxAllow 
   BackColor       =   &H00E0E0E0&
   ...
   Begin VB.Frame fraButtons 
      ...
      Width           =   8640
   End
   Begin TrueOleDBGrid80.TDBGrid tdgNonTaxAllow 
      Height          =   3000
      Left            =   15
      TabIndex        =   1
      Top             =   15
      ...
      Columns(0).DataField=   "nontaxallow_id"
      ...
      Columns(1).DataField=   "nontaxallow_description"
      Columns(1)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(2)._VlistStyle=   0
      Columns(2)._MaxComboItems=   5
      Columns(2).Caption=   "Amount"
      Columns(2).DataField=   "nontaxallow_amt"
      Columns(2).NumberFormat=   "#,##0.00"
      Columns(2).ExternalEditor=   "txtAmt"
      ...
      Splits(0)._ColumnProps(9)=   "Column(1).Width=9710"
      Splits(0)._ColumnProps(10)=   "Column(1).DividerColor=0"
      Splits(0)._ColumnProps(11)=   "Column(1)._WidthInPix=9631"
      Splits(0)._ColumnProps(12)=   "Column(1)._EditAlways=0"
      Splits(0)._ColumnProps(13)=   "Column(1)._ColStyle=8704"
      Splits(0)._ColumnProps(14)=   "Column(1).Order=2"
      Splits(0)._ColumnProps(15)=   "Column(2).Width=2646"
      Splits(0)._ColumnProps(16)=   "Column(2).DividerStyle=0"
      Splits(0)._ColumnProps(17)=   "Column(2).DividerColor=0"
      Splits(0)._ColumnProps(18)=   "Column(2)._WidthInPix=2593"
      Splits(0)._ColumnProps(19)=   "Column(2)._EditAlways=0"
      Splits(0)._ColumnProps(20)=   "Column(2)._ColStyle=514"
      Splits(0)._ColumnProps(21)=   "Column(2).Order=3"
      Splits(0)._ColumnProps(22)=   "Column(2)._HeadDivider=0"
      Splits(0)._ColumnProps(23)=   "Column(3).Width=873"
      Splits(0)._ColumnProps(24)=   "Column(3).DividerColor=0"
      Splits(0)._ColumnProps(25)=   "Column(3)._WidthInPix=794"
   ...
   End
   Begin TDBNumber6Ctl.TDBNumber txtAmt 
      Height          =   270
      Left            =   9345
      TabIndex        =   2
      Top             =   1050
      ...
      _ExtentX        =   2752
      _ExtentY        =   476
      Calculator      =   "frmAdNonTaxAllow.frx":0000
      Caption         =   "frmAdNonTaxAllow.frx":0020
      ...
      EndProperty
      DropDown        =   "frmAdNonTaxAllow.frx":008C
      Keys            =   "frmAdNonTaxAllow.frx":00AA
      Spin            =   "frmAdNonTaxAllow.frx":00F4
      AlignHorizontal =   1
      AlignVertical   =   0
      Appearance      =   0
      BackColor       =   16777215
   ...
   End
End
Attribute VB_Name = "frmAdNonTaxAllow"
