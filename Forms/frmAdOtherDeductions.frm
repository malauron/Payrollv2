...
Begin VB.Form frmAdOtherDeductions 
   BackColor       =   &H00E0E0E0&
   ClientHeight    =   6975
   ClientLeft      =   60
   ClientTop       =   60
   ...
   Begin VB.Frame fraButtons 
      ...
      Begin TDBNumber6Ctl.TDBNumber txtTotal 
         ...
         _ExtentX        =   3889
         _ExtentY        =   556
         Calculator      =   "frmAdOtherDeductions.frx":0000
         Caption         =   "frmAdOtherDeductions.frx":0020
         ...
         EndProperty
         DropDown        =   "frmAdOtherDeductions.frx":008C
         Keys            =   "frmAdOtherDeductions.frx":00AA
         Spin            =   "frmAdOtherDeductions.frx":00F4
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   0
      ...
      Begin TDBNumber6Ctl.TDBNumber txtNoOfRecords 
         ...
         _ExtentX        =   2963
         _ExtentY        =   556
         Calculator      =   "frmAdOtherDeductions.frx":011C
         Caption         =   "frmAdOtherDeductions.frx":013C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmAdOtherDeductions.frx":01A8
         Keys            =   "frmAdOtherDeductions.frx":01C6
         Spin            =   "frmAdOtherDeductions.frx":0210
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   0
         BackColor       =   -2147483643
      ...
      Begin VB.Frame Frame1 
         ...
         Begin lvButton.lvButtons_H cmdMenu 
            ...
            Value           =   0   'False
            ImgAlign        =   1
            Image           =   "frmAdOtherDeductions.frx":0238
            ImgSize         =   24
            cBack           =   14737632
         End
         Begin lvButton.lvButtons_H cmdMenu 
            ...
            Value           =   0   'False
            ImgAlign        =   1
            Image           =   "frmAdOtherDeductions.frx":1F12
            ImgSize         =   24
            cBack           =   14737632
         End
         Begin lvButton.lvButtons_H cmdMenu 
            ...
            Value           =   0   'False
            ImgAlign        =   1
            Image           =   "frmAdOtherDeductions.frx":3BEC
            ImgSize         =   24
            cBack           =   14737632
         End
         Begin lvButton.lvButtons_H cmdMenu 
            ...
            Value           =   0   'False
            ImgAlign        =   1
            Image           =   "frmAdOtherDeductions.frx":58C6
            ImgSize         =   24
            cBack           =   14737632
         End
         Begin lvButton.lvButtons_H cmdMenu 
            ...
            Value           =   0   'False
            ImgAlign        =   1
            Image           =   "frmAdOtherDeductions.frx":65A0
            cBack           =   14737632
         End
         Begin lvButton.lvButtons_H cmdMenu 
            Height          =   465
            ...
            Value           =   0   'False
            ImgAlign        =   1
            Image           =   "frmAdOtherDeductions.frx":6E7A
            cBack           =   14737632
         End
      End
   ...
   Begin VB.Frame fra1 
      ...
      Begin TrueOleDBList80.TDBCombo tdbPayrollPeriod 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmAdOtherDeductions.frx":CA9C
      ...
      Begin TDBText6Ctl.TDBText txtSearch 
         ...
         _ExtentX        =   6853
         _ExtentY        =   529
         Caption         =   "frmAdOtherDeductions.frx":CB46
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmAdOtherDeductions.frx":CBB2
         Key             =   "frmAdOtherDeductions.frx":CBD0
         BackColor       =   -2147483643
         EditMode        =   0
      ...
      Begin TrueOleDBList80.TDBCombo tdbSort 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmAdOtherDeductions.frx":CC14
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin TrueOleDBList80.TDBCombo tdbOtherDeductions 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmAdOtherDeductions.frx":CCBE
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
   ...
   Begin TrueOleDBGrid80.TDBGrid tdgOtherDeductions 
      ...
      Columns(0).DataField=   "otherdeductionslnecode"
      Columns(0)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(1)._VlistStyle=   0
      Columns(1)._MaxComboItems=   5
   ...
   End
End
Attribute VB_Name = "frmAdOtherDeductions"
...
Public mOtherDeductionsCode         As Integer

Public rsOtherDeductions            As ADODB.Recordset
...
Private Sub cmdmenu_Click(Index As Integer)
    ...
    Select Case Index
      ...
      Case 0:
            If mPerCode <> 0 Then
              frmAdOtherDeductions2.mAdd = True
              frmAdOtherDeductions2.Show vbModal
            Else
              MsgBox "Please select a payroll period.", vbExclamation + vbOKOnly
            End If
      Case 1:
            If mPerCode <> 0 Then
              frmAdOtherDeductions2.mAdd = False
              frmAdOtherDeductions2.Show vbModal
            Else
              MsgBox "Please select a payroll period.", vbExclamation + vbOKOnly
            End If
      ...
      Case 3:
            ...
            If rsOtherDeductions.RecordCount <= 0 Then Exit Sub
            
            If MsgBox("Do you want to delete this Deductions entry?", vbInformation + vbYesNo) = vbYes Then
                
                ConMain.Execute "delete from Deductions where otherDeductionslnecode = " & rsOtherDeductions!otherDeductionslnecode & " and percode = " & mPerCode & ""
                
                If rsOtherDeductions.AbsolutePosition = rsOtherDeductions.RecordCount Then
                    mRow = rsOtherDeductions.AbsolutePosition - 1
                Else
                    mRow = rsOtherDeductions.AbsolutePosition
                End If
                ...
                If rsOtherDeductions.RecordCount > 0 Then
                    ...
                    txtNoOfRecords.Text = Format(rsOtherDeductions.RecordCount, "#,##0")
                    
                    Lock_Button "TTFTTT", cmdMenu, 5
                          rsOtherDeductions.MoveFirst
                    Do While Not rsOtherDeductions.EOF
                        mTotal = mTotal + rsOtherDeductions!amount
                ...
                If mRow > 0 Then
                    rsOtherDeductions.AbsolutePosition = mRow
                End If
                
                tdgOtherDeductions.SetFocus
      ...
      Case 5:
            ...
            If mPerCode = 0 Then
                ...
                Exit Sub
            Else
                If mOtherDeductionsCode = 0 Then
                    MsgBox "Please select an Deductions type.", vbExclamation + vbOKOnly
            ...
            With frmUtilImportOtherded
                .mImportType = "Otherded"
                .mTypeCode = tdbOtherDeductions.BoundText
                .Show vbModal
            End With
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    ...
    mPerCode = 0
    mOtherDeductionsCode = 0
    
    Set rsOtherDeductions = Nothing
...
Private Sub tdbOtherDeductions_GotFocus()
    ...
    If mOtherDeductionsCode <> 0 Then
        tdbOtherDeductions.BoundText = mOtherDeductionsCode
    Else
...
Private Sub tdbSort_ItemChange()
    On Error Resume Next
    rsOtherDeductions.Sort = tdbSort.BoundText
End Sub

Private Sub tdgOtherDeductions_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = 46 Then
        cmdmenu_Click 3
    End If
End Sub
...
Private Sub txtSearch_KeyPress(KeyAscii As Integer)
  If KeyAscii = 13 Then
    SendKeys "{TAB}"
  Else
    SearchRecord KeyAscii, txtSearch, rsOtherDeductions, txtSearch.Text, tdbSort.BoundText
  End If
End Sub
...
Public Sub Get_List()
    ...
    If Trim(tdbOtherDeductions.Text) <> "" And Not IsNull(tdbOtherDeductions.SelectedItem) And tdbOtherDeductions.ApproxCount > 0 Then
        mOtherDeductionsCode = tdbOtherDeductions.BoundText
    Else
        mOtherDeductionsCode = 0
    End If
    
    NetOpen rsOtherDeductions, "select x1.*,x2.dummycode,concat(x2.lastname,', ',x2.firstname,' ',x2.middlename) employeename,x3.otherDeductionsname from Deductions x1 " & _
               "left outer join employee x2 on x1.employeecode = x2.employeecode " & _
               "left outer join otherDeductions x3 on x1.otherDeductionscode = x3.otherDeductionscode  where x1.percode = " & mPerCode & " and x1.otherDeductionscode = " & mOtherDeductionsCode & " order by " & tdbSort.BoundText & ""
    
    Set tdgOtherDeductions.DataSource = rsOtherDeductions
    
     If mPerCode <> 0 And mOtherDeductionsCode <> 0 Then
