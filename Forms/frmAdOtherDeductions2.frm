...
Begin VB.Form frmAdOtherDeductions2 
   BackColor       =   &H00FFFFFF&
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Employee's Other Deductions Detail"
   ClientHeight    =   2475
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7845
   ...
   Begin VB.Frame fraButtons 
      ...
      Begin lvButton.lvButtons_H cmdClose 
         ...
         Value           =   0   'False
         ImgAlign        =   1
         Image           =   "frmAdOtherDeductions2.frx":0000
         cBack           =   14737632
      End
      Begin lvButton.lvButtons_H cmdOK 
         ...
         Value           =   0   'False
         ImgAlign        =   1
         Image           =   "frmAdOtherDeductions2.frx":0CDA
         cBack           =   14737632
      End
   End
   Begin VB.Frame fraMain 
      ...
      Begin TDBNumber6Ctl.TDBNumber txtAmount 
         ...
         _ExtentX        =   2646
         _ExtentY        =   556
         Calculator      =   "frmAdOtherDeductions2.frx":19B4
         Caption         =   "frmAdOtherDeductions2.frx":19D4
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmAdOtherDeductions2.frx":1A40
         Keys            =   "frmAdOtherDeductions2.frx":1A5E
         Spin            =   "frmAdOtherDeductions2.frx":1AA8
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   0
      ...
      Begin TrueOleDBList80.TDBCombo tdbEmployee 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmAdOtherDeductions2.frx":1AD0
      ...
      Begin TDBText6Ctl.TDBText txtRemarks 
         ...
         _ExtentX        =   10689
         _ExtentY        =   1720
         Caption         =   "frmAdOtherDeductions2.frx":1B7A
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmAdOtherDeductions2.frx":1BE6
         Key             =   "frmAdOtherDeductions2.frx":1C04
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   4210752
         ReadOnly        =   0
   ...
   End
End
Attribute VB_Name = "frmAdOtherDeductions2"
...
Private Sub cmdClose_Click()
    ...
    frmAdOtherDeductions.tdgOtherDeductions.SetFocus
...
Private Sub cmdOK_Click()
    ...
    With frmAdOtherDeductions
        ...
        If mAdd = True Then
            ...
            mOtherDeductionsLneCode = LastCodeUsed("lastotherDeductionslnecode", .mPerCode)
            ...
            ConMain.Execute "insert into Deductions (otherDeductionscode,percode,employeecode,costcentercode,divisioncode," & _
                                    ...
                                    "otherDeductionslnecode,remarks) values ( " & _
                                    .mOtherDeductionsCode & "," & .mPerCode & "," & tdbEmployee.BoundText & ", " & mCostCenterCode & "," & mDivisionCode & ", " & _
                                    ...
                                    mOtherDeductionsLneCode & ",'" & Swap(txtRemarks.Text) & "')"
                
        Else
            
            mOtherDeductionsLneCode = .rsOtherDeductions!otherDeductionslnecode
            ConMain.Execute "update Deductions set costcentercode = " & mCostCenterCode & ",divisioncode = " & mDivisionCode & ",branchcode = " & mBranchCode & ",sectioncode = " & mSectionCode & ", " & _
                            ...
                            "remarks = '" & Swap(txtRemarks.Text) & "' where otherDeductionslnecode = " & mOtherDeductionsLneCode & " and percode = " & .mPerCode & ""
        ...
        .rsOtherDeductions.MoveFirst
        .rsOtherDeductions.Find "otherDeductionslnecode = " & mOtherDeductionsLneCode & ""
...
Private Sub Form_Load()
    ...
    If mAdd = False Then
        bind_tdb ConMain, tdbEmployee, "select employeecode,concat(lastname,', ',firstname,' ',middlename) employeename, " & _
                        ...
                        "where employeecode = " & frmAdOtherDeductions.rsOtherDeductions!employeecode & " order by lastname,firstname,middlename", "employeename", "employeecode"
        
        tdbEmployee.Enabled = False
        tdbEmployee.BoundText = frmAdOtherDeductions.rsOtherDeductions!employeecode
        txtAmount.Text = Format(frmAdOtherDeductions.rsOtherDeductions!amount, "#,##0.00")
        txtRemarks.Text = frmAdOtherDeductions.rsOtherDeductions!remarks
    Else
        bind_tdb ConMain, tdbEmployee, "select employeecode,concat(lastname,', ',firstname,' ',middlename) employeename, " & _
