...
Begin VB.Form frmAdOtherEarnings 
   BackColor       =   &H00E0E0E0&
   ClientHeight    =   8895
   ClientLeft      =   60
   ClientTop       =   60
   ...
   Begin VB.Frame fra1 
      ...
      Begin TrueOleDBList80.TDBCombo tdbPayrollPeriod 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmAdOtherEarnings.frx":0000
      ...
      Begin TDBText6Ctl.TDBText txtSearch 
         ...
         _ExtentX        =   6853
         _ExtentY        =   529
         Caption         =   "frmAdOtherEarnings.frx":00AA
         ...
         EndProperty
         DropDown        =   "frmAdOtherEarnings.frx":0116
         Key             =   "frmAdOtherEarnings.frx":0134
      ...
      Begin TrueOleDBList80.TDBCombo tdbSort 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmAdOtherEarnings.frx":0178
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      End
      Begin TrueOleDBList80.TDBCombo tdbOtherEarnings 
         Height          =   345
         Left            =   6900
         TabIndex        =   1
         Tag             =   "Municipal"
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmAdOtherEarnings.frx":0222
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
   ...
   Begin VB.Frame fraButtons 
      ...
      Begin TDBNumber6Ctl.TDBNumber txtTotal 
         ...
         _ExtentX        =   3889
         _ExtentY        =   556
         Calculator      =   "frmAdOtherEarnings.frx":02CC
         Caption         =   "frmAdOtherEarnings.frx":02EC
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmAdOtherEarnings.frx":0358
         Keys            =   "frmAdOtherEarnings.frx":0376
         Spin            =   "frmAdOtherEarnings.frx":03C0
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   0
         BackColor       =   -2147483643
      ...
      Begin TDBNumber6Ctl.TDBNumber txtNoOfRecords 
         ...
         _ExtentX        =   2963
         _ExtentY        =   556
         Calculator      =   "frmAdOtherEarnings.frx":03E8
         Caption         =   "frmAdOtherEarnings.frx":0408
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmAdOtherEarnings.frx":0474
         Keys            =   "frmAdOtherEarnings.frx":0492
         Spin            =   "frmAdOtherEarnings.frx":04DC
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   0
         BackColor       =   -2147483643
      ...
      Begin VB.Frame Frame1 
         ...
         Begin lvButton.lvButtons_H cmdMenu 
            ...
            Value           =   0   'False
            ImgAlign        =   1
            Image           =   "frmAdOtherEarnings.frx":0504
            ImgSize         =   24
            cBack           =   14737632
         End
         Begin lvButton.lvButtons_H cmdMenu 
            ...
            Value           =   0   'False
            ImgAlign        =   1
            Image           =   "frmAdOtherEarnings.frx":21DE
            ImgSize         =   24
            cBack           =   14737632
         End
         Begin lvButton.lvButtons_H cmdMenu 
            ...
            Value           =   0   'False
            ImgAlign        =   1
            Image           =   "frmAdOtherEarnings.frx":3EB8
            ImgSize         =   24
            cBack           =   14737632
         End
         Begin lvButton.lvButtons_H cmdMenu 
            ...
            Value           =   0   'False
            ImgAlign        =   1
            Image           =   "frmAdOtherEarnings.frx":5B92
            ImgSize         =   24
            cBack           =   14737632
         End
         Begin lvButton.lvButtons_H cmdMenu 
            ...
            Value           =   0   'False
            ImgAlign        =   1
            Image           =   "frmAdOtherEarnings.frx":686C
            cBack           =   14737632
         End
         Begin lvButton.lvButtons_H cmdMenu 
            Height          =   465
            ...
            Value           =   0   'False
            ImgAlign        =   1
            Image           =   "frmAdOtherEarnings.frx":7146
            cBack           =   14737632
         End
      End
   ...
   Begin TrueOleDBGrid80.TDBGrid tdgOtherEarnings 
      ...
      Columns(0).DataField=   "otherearningslnecode"
      Columns(0)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(1)._VlistStyle=   0
      Columns(1)._MaxComboItems=   5
   ...
   End
End
Attribute VB_Name = "frmAdOtherEarnings"
...
Public mOtherEarningsCode       As Integer

Public rsOtherEarnings          As ADODB.Recordset
...
Private Sub cmdmenu_Click(Index As Integer)
    ...
    Select Case Index
      ...
      Case 0:
            ...
            If mPerCode <> 0 Then
              frmADOtherEarnings2.mAdd = True
              frmADOtherEarnings2.Show vbModal
            Else
      ...
      Case 1:
            ...
            If mPerCode <> 0 Then
              frmADOtherEarnings2.mAdd = False
              frmADOtherEarnings2.Show vbModal
            Else
              MsgBox "Please select a payroll period.", vbExclamation + vbOKOnly
            End If
      ...
      Case 3:
            ...
            If rsOtherEarnings.RecordCount <= 0 Then Exit Sub
            
            If MsgBox("Do you want to delete this earnings entry?", vbInformation + vbYesNo) = vbYes Then
                
                ConMain.Execute "delete from earnings where otherearningslnecode = " & rsOtherEarnings!otherearningslnecode & " and percode = " & mPerCode & ""
                
                If rsOtherEarnings.AbsolutePosition = rsOtherEarnings.RecordCount Then
                    mRow = rsOtherEarnings.AbsolutePosition - 1
                Else
                    mRow = rsOtherEarnings.AbsolutePosition
                End If
                ...
                If mRow > 0 Then
                    rsOtherEarnings.AbsolutePosition = mRow
                End If
      ...
      Case 5:
            ...
            If mPerCode = 0 Then
                ...
                Exit Sub
            Else
                If mOtherEarningsCode = 0 Then
                    MsgBox "Please select an earnings type.", vbExclamation + vbOKOnly
                    tdbOtherEarnings.SetFocus
                    Exit Sub
                End If
            End If
        
            With frmUtilImportOtherded
                .mImportType = "OtherEarnings"
                .mTypeCode = tdbOtherEarnings.BoundText
                .Show vbModal
            End With
...
'    NetOpen rsTmp, "select percode from payrollperiod order by percode"
'    NetOpen rsTmp2, "select * from earnings order by percode"
'
...
'
'            rsTmp2.Filter = "percode = " & rsTmp!percode & ""
'            If Not rsTmp2.EOF Then
'                rsTmp2.MoveFirst
'                I = 1
'                Do While Not rsTmp2.EOF
'                    ConMain.Execute "update earnings set otherearningslnecode = " & I & " where percode = " & rsTmp!percode & " and employeecode = " & rsTmp2!employeecode & " and amount = " & rsTmp2!amount & ""
'                    I = I + 1
'                    rsTmp2.MoveNext
'                Loop
'
'                ConMain.Execute "update payrollperiod set lastotherearningslnecode = " & I & " where percode = " & rsTmp!percode & ""
'
'            End If
'            rsTmp.MoveNext
'
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    ...
    mPerCode = 0
    mOtherEarningsCode = 0
    Set rsOtherEarnings = Nothing
...
Private Sub tdbOtherEarnings_GotFocus()

    If Trim(tdbOtherEarnings.Text) <> "" And Not IsNull(tdbOtherEarnings.SelectedItem) And tdbOtherEarnings.ApproxCount > 0 Then
        tdbOtherEarnings.Tag = tdbOtherEarnings.BoundText
    Else
        tdbOtherEarnings.Tag = ""
    End If
    
    bind_tdb ConMain, tdbOtherEarnings, "select otherearningscode,otherearningsname from otherearnings where isactive = 'Y' order by otherearningsname", "otherearningsname", "otherearningscode"
    
    If mOtherEarningsCode <> 0 Then
        tdbOtherEarnings.BoundText = mOtherEarningsCode
    Else
        tdbOtherEarnings.BoundText = ""
    End If
    
End Sub

Private Sub tdbOtherEarnings_KeyPress(KeyAscii As Integer)
    ...
    Else
        ...
        SearchList KeyAscii, tdbOtherEarnings, tdbOtherEarnings.RowSource, tdbOtherEarnings.Text
...
Private Sub tdbSort_ItemChange()
    On Error Resume Next
    rsOtherEarnings.Sort = tdbSort.BoundText
End Sub

Private Sub tdgOtherEarnings_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = 46 Then
        cmdmenu_Click 3
    End If
End Sub
...
Private Sub txtSearch_KeyPress(KeyAscii As Integer)
  If KeyAscii = 13 Then
    SendKeys "{TAB}"
  Else
    SearchRecord KeyAscii, txtSearch, rsOtherEarnings, txtSearch.Text, tdbSort.BoundText
  End If
End Sub
...
Public Sub Get_List()
    ...
    If Trim(tdbOtherEarnings.Text) <> "" And Not IsNull(tdbOtherEarnings.SelectedItem) And tdbOtherEarnings.ApproxCount > 0 Then
        mOtherEarningsCode = tdbOtherEarnings.BoundText
    Else
        mOtherEarningsCode = 0
    End If
    
    NetOpen rsOtherEarnings, "select x1.*,x2.dummycode,concat(x2.lastname,', ',x2.firstname,' ',x2.middlename) employeename,x3.otherearningsname from earnings x1 " & _
               "left outer join employee x2 on x1.employeecode = x2.employeecode " & _
               "left outer join otherearnings x3 on x1.otherearningscode = x3.otherearningscode  where x1.percode = " & mPerCode & " and x1.otherearningscode = " & mOtherEarningsCode & " order by " & tdbSort.BoundText & ""
    
    Set tdgOtherEarnings.DataSource = rsOtherEarnings
    
     If mPerCode <> 0 And mOtherEarningsCode <> 0 Then
