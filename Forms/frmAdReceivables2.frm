...
Begin VB.Form frmAdReceivables2 
   BackColor       =   &H00FFFFFF&
   ...
   Begin VB.Frame fraButtons 
      ...
      Begin lvButton.lvButtons_H cmdClose 
         ...
         Value           =   0   'False
         ImgAlign        =   1
         Image           =   "frmAdReceivables2.frx":0000
         cBack           =   14737632
      End
      Begin lvButton.lvButtons_H cmdOK 
         ...
         Value           =   0   'False
         ImgAlign        =   1
         Image           =   "frmAdReceivables2.frx":0CDA
         cBack           =   14737632
      End
   End
   Begin VB.Frame fraMain 
      ...
      Begin TDBNumber6Ctl.TDBNumber txtAmount 
         ...
         _ExtentX        =   2646
         _ExtentY        =   556
         Calculator      =   "frmAdReceivables2.frx":19B4
         Caption         =   "frmAdReceivables2.frx":19D4
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmAdReceivables2.frx":1A40
         Keys            =   "frmAdReceivables2.frx":1A5E
         Spin            =   "frmAdReceivables2.frx":1AA8
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   0
      ...
      Begin TrueOleDBList80.TDBCombo tdbEmployee 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmAdReceivables2.frx":1AD0
      ...
      Begin TDBText6Ctl.TDBText txtRemarks 
         ...
         _ExtentX        =   10689
         _ExtentY        =   1720
         Caption         =   "frmAdReceivables2.frx":1B7A
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmAdReceivables2.frx":1BE6
         Key             =   "frmAdReceivables2.frx":1C04
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   4210752
         ReadOnly        =   0
   ...
   End
End
Attribute VB_Name = "frmAdReceivables2"
...
Private Sub cmdClose_Click()
    ...
    frmAdReceivables.tdgReceivables.SetFocus
...
Private Sub cmdOK_Click()
    ...
    With frmAdReceivables
        ...
        If mAdd = True Then
            ...
            mReceivableCode = LastReceivableCode(Format(rsDateTime!currentdate, "YYYY-MM-DD"))
            
            ConMain.Execute "insert into receivables (ReceivableCode,referenceno,deductioncode,employeecode,trnxdate,amount, " & _
                            "branchcode,divisioncode,costcentercode,sectioncode) values ( " & _
                             Format(333333303, "000000000") & ",''," & .mDeductionType & "," & tdbEmployee.BoundText & ",curdate()," & Format(txtAmount.Text, "##0.00") & "," & _
                             mBranchCode & "," & mDivisionCode & "," & mCostCenterCode & "," & mSectionCode & ")"
                
        Else
            
            mReceivableCode = .rsReceivables!ReceivableCode
            
            ConMain.Execute "update vouchers set amount = " & Format(txtAmount.Text, "##0.00") & ",remarks = '" & Swap(txtRemarks.Text) & "' where ReceivableCode = " & mReceivableCode & " "
...
'        ConMain.Execute "update payrollperiod set genpay = 'N' where percode = " & .mPerCode & ""
        ...
        .rsReceivables.MoveFirst
        .rsReceivables.Find "ReceivableCode = " & mReceivableCode & ""
...
Private Sub Form_Load()
    ...
    If mAdd = False Then
        bind_tdb ConMain, tdbEmployee, "select employeecode,concat(lastname,', ',firstname,' ',middlename) employeename, " & _
                        ...
                        "where employeecode = " & frmAdReceivables.rsReceivables!EmployeeCode & " order by lastname,firstname,middlename", "employeename", "employeecode"
        
        tdbEmployee.Enabled = False
        tdbEmployee.BoundText = frmAdReceivables.rsReceivables!EmployeeCode
        txtAmount.Text = Format(frmAdReceivables.rsReceivables!amount, "#,##0.00")
        txtRemarks.Text = frmAdReceivables.rsReceivables!remarks & ""
    Else
        bind_tdb ConMain, tdbEmployee, "select employeecode,concat(lastname,', ',firstname,' ',middlename) employeename, " & _
                        "branchcode,divisioncode,costcentercode,sectioncode  from employee where isactive = 'Y' order by lastname,firstname,middlename", "employeename", "employeecode"
    End If
