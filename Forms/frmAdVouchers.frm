...
Begin VB.Form frmAdVouchers 
   ...
   Begin VB.Frame fraButtons 
      ...
      Begin TDBNumber6Ctl.TDBNumber txtTotal 
         ...
         _ExtentX        =   3889
         _ExtentY        =   556
         Calculator      =   "frmAdVouchers.frx":0000
         Caption         =   "frmAdVouchers.frx":0020
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmAdVouchers.frx":008C
         Keys            =   "frmAdVouchers.frx":00AA
         Spin            =   "frmAdVouchers.frx":00F4
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   0
      ...
      Begin TDBNumber6Ctl.TDBNumber txtNoOfRecords 
         ...
         _ExtentX        =   2963
         _ExtentY        =   556
         Calculator      =   "frmAdVouchers.frx":011C
         Caption         =   "frmAdVouchers.frx":013C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmAdVouchers.frx":01A8
         Keys            =   "frmAdVouchers.frx":01C6
         Spin            =   "frmAdVouchers.frx":0210
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   0
         BackColor       =   -2147483643
      ...
      End
   End
   Begin TrueOleDBGrid80.TDBGrid tdgVouchers 
      Height          =   4005
      Left            =   0
      TabIndex        =   4
      Top             =   1770
   ...
   Begin VB.Frame fra1 
      ...
      Begin TrueOleDBList80.TDBCombo tdbValidityPeriod 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmAdVouchers.frx":CA9C
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
      ...
      Begin TDBText6Ctl.TDBText txtSearch 
         ...
         _ExtentX        =   6853
         _ExtentY        =   529
         Caption         =   "frmAdVouchers.frx":CB46
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmAdVouchers.frx":CBB2
         Key             =   "frmAdVouchers.frx":CBD0
         BackColor       =   -2147483643
         EditMode        =   0
      ...
      Begin TrueOleDBList80.TDBCombo tdbSort 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmAdVouchers.frx":CC14
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      End
      Begin TrueOleDBList80.TDBCombo tdbVouchersType 
         Height          =   345
         Left            =   7230
         TabIndex        =   1
         Tag             =   "Municipal"
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmAdVouchers.frx":CCBE
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
         ...
         _StyleDefs(60)  =   ":id=42,.parent=33"
      End
      Begin lvButton.lvButtons_H cmdValidityPeriod 
         Height          =   315
         Left            =   5580
         TabIndex        =   24
   ...
   End
End
Attribute VB_Name = "frmAdVouchers"
...
Public mVoucherValidPeriodCode          As Integer
Public mVoucherType                As String
Public rsVouchers                       As ADODB.Recordset
    ...
    Select Case Index
      ...
      Case 0:
            ...
            If mVoucherValidPeriodCode <> 0 Then
              frmAdVouchers2.mAdd = True
              frmAdVouchers2.Show vbModal
            Else
      ...
      Case 3:
            ...
            If rsVouchers.RecordCount <= 0 Then Exit Sub
            
            If MsgBox("Do you want to delete this voucher entry?", vbInformation + vbYesNo) = vbYes Then
                
                ConMain.Execute "delete from vouchers where vouchercode = " & rsVouchers!vouchercode & ""
                
                If rsVouchers.AbsolutePosition = rsVouchers.RecordCount Then
                    mRow = rsVouchers.AbsolutePosition - 1
                Else
                    mRow = rsVouchers.AbsolutePosition
                End If
                ...
                If rsVouchers.RecordCount > 0 Then
                    ...
                    txtNoOfRecords.Text = Format(rsVouchers.RecordCount, "#,##0")
                    
                    Lock_Button "TTFTTT", cmdMenu, 5
                          rsVouchers.MoveFirst
                    Do While Not rsVouchers.EOF
                        mTotal = mTotal + rsVouchers!amount
                        rsVouchers.MoveNext
                    Loop
                ...
                If mRow > 0 Then
                    rsVouchers.AbsolutePosition = mRow
                End If
                
                tdgVouchers.SetFocus
      ...
      Case 5:
            ...
            If mVoucherValidPeriodCode = 0 Then
                ...
                Exit Sub
            Else
                If mVoucherType = "" Then
                    MsgBox "Please select a voucher type.", vbExclamation + vbOKOnly
                    tdbVouchersType.SetFocus
                    Exit Sub
                End If
            End If
        
            With frmUtilImportOtherded
                .mImportType = "Vouchers"
                .mVoucherType = tdbVouchersType.BoundText
                .Show vbModal
            End With
...
Private Sub cmdValidityPeriod_Click()
    frmAdVouchers3.Show vbModal
End Sub
...
Private Sub Form_Load()
    ...
    'bind_tdb ConMain, tdbValidityPeriod, "select percode, description, wrkdatefrom, wrkdateto,payyear,paymonth,payfreqcode from payrollperiod order by description desc", "description", "percode"
      ...
      For i = 1 To 3
        ...
        Select Case i
            Case 1: .Fields("code") = "dummycode"
                    .Fields("description") = "Voucher Number"
            Case 2: .Fields("code") = "employeeid"
                    .Fields("description") = "Employee ID"
            Case 3: .Fields("code") = "employeename"
    ...
    With rsTmp
        ...
        .AddNew
        Select Case i
            Case 1: .Fields("code") = "groc"
                    .Fields("description") = "Grocery"
            Case 2: .Fields("code") = "butc"
                    .Fields("description") = "Buthcery and Pastry"
        End Select
        .Update
        Next
    End With
    
    With tdbVouchersType
        .BoundColumn = "code"
        .ListField = "description"
        .Columns(0).DataField = "code"
        .Columns(1).DataField = "description"
...
Private Sub Form_Resize()
    ...
    With fraButtons
        .Top = tdgVouchers.Top + tdgVouchers.Height
        .Left = 0
        .Width = Me.ScaleWidth
    End With
...
Private Sub tdbVouchersType_GotFocus()

    If Trim(tdbVouchersType.Text) <> "" And Not IsNull(tdbVouchersType.SelectedItem) And tdbVouchersType.ApproxCount > 0 Then
        tdbVouchersType.Tag = tdbVouchersType.BoundText
    Else
        tdbVouchersType.Tag = ""
    End If
    
'    bind_tdb ConMain, tdbVouchersType, "select Voucherscode,Vouchersname from Vouchers where isactive = 'Y' order by Vouchersname", "Vouchersname", "Voucherscode"
    
    If mVoucherType <> "" Then
        tdbVouchersType.BoundText = mVoucherType
    Else
        tdbVouchersType.BoundText = ""
    End If
    
End Sub

Private Sub tdbVouchersType_KeyPress(KeyAscii As Integer)
    ...
    Else
        ...
        SearchList KeyAscii, tdbVouchersType, tdbVouchersType.RowSource, tdbVouchersType.Text
...
Private Sub tdbSort_ItemChange()
    On Error Resume Next
    rsVouchers.Sort = tdbSort.BoundText
End Sub

Private Sub tdgVouchers_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = 46 Then
        cmdmenu_Click 3
    End If
End Sub
...
Private Sub txtSearch_KeyPress(KeyAscii As Integer)
  If KeyAscii = 13 Then
    SendKeys "{TAB}"
  Else
    SearchRecord KeyAscii, txtSearch, rsVouchers, txtSearch.Text, tdbSort.BoundText
  End If
End Sub
...
Public Sub Get_List()
    ...
    NetOpen rsVouchers, "select x1.*,x2.dummycode employeeid,concat(x2.lastname,', ',x2.firstname,' ',x2.middlename) employeename,x3.description from vouchers x1 " & _
               "left outer join employee x2 on x1.employeecode = x2.employeecode " & _
               "left outer join vouchervalidperiod x3 on x1.vouchervalidperiodcode = x3.vouchervalidperiodcode  where x1.vouchervalidperiodcode = " & mVoucherValidPeriodCode & " and x1.vouchertype = '" & mVoucherType & "' order by " & tdbSort.BoundText & ""
    
    Set tdgVouchers.DataSource = rsVouchers
    
    If mVoucherValidPeriodCode <> 0 And mVoucherType <> "" Then
