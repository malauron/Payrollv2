...
Begin VB.Form frmAdVouchers2 
   ...
   Begin VB.Frame fraMain 
      ...
      Begin TDBNumber6Ctl.TDBNumber txtAmount 
         ...
         _ExtentX        =   2646
         _ExtentY        =   556
         Calculator      =   "frmAdVouchers2.frx":0000
         Caption         =   "frmAdVouchers2.frx":0020
         ...
         EndProperty
         DropDown        =   "frmAdVouchers2.frx":008C
         Keys            =   "frmAdVouchers2.frx":00AA
         Spin            =   "frmAdVouchers2.frx":00F4
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   0
      ...
      Begin TrueOleDBList80.TDBCombo tdbEmployee 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmAdVouchers2.frx":011C
      ...
      Begin TDBText6Ctl.TDBText txtRemarks 
         ...
         _ExtentX        =   10689
         _ExtentY        =   1720
         Caption         =   "frmAdVouchers2.frx":01C6
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmAdVouchers2.frx":0232
         Key             =   "frmAdVouchers2.frx":0250
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   4210752
         ReadOnly        =   0
   ...
   Begin VB.Frame fraButtons 
      ...
      Begin lvButton.lvButtons_H cmdOK 
         ...
         Value           =   0   'False
         ImgAlign        =   1
         Image           =   "frmAdVouchers2.frx":0F6E
         cBack           =   14737632
      End
   End
End
Attribute VB_Name = "frmAdVouchers2"
...
Private Sub cmdClose_Click()
    ...
    frmAdVouchers.tdgVouchers.SetFocus
...
Private Sub cmdOK_Click()
    ...
    With frmAdVouchers
        ...
        If mAdd = True Then
            ...
            mVoucherCode = LastCode(.mVoucherType & " - VoucherCode")
            
            ConMain.Execute "insert into vouchers (vouchercode,dummycode,employeecode,amount,dateissued, " & _
                            "vouchervalidperiodcode,vouchertype,remarks," & _
                            "branchcode,divisioncode,costcentercode,sectioncode) values ( " & _
                             mVoucherCode & ",'" & Format(mVoucherCode, "00000000000") & "', " & tdbEmployee.BoundText & "," & Format(txtAmount.Text, "##0.00") & ",curdate()," & _
                             .mVoucherValidPeriodCode & ",'" & .mVoucherType & "','" & Swap(txtRemarks.Text) & "'," & _
                             mBranchCode & "," & mDivisionCode & "," & mCostCenterCode & "," & mSectionCode & ")"
                
        Else
            
            mVoucherCode = .rsVouchers!vouchercode
            
            ConMain.Execute "update vouchers set amount = " & Format(txtAmount.Text, "##0.00") & ",remarks = '" & Swap(txtRemarks.Text) & "' where vouchercode = " & mVoucherCode & " "
...
'        ConMain.Execute "update payrollperiod set genpay = 'N' where percode = " & .mPerCode & ""
        ...
        .rsVouchers.MoveFirst
        .rsVouchers.Find "vouchercode = " & mVoucherCode & ""
...
Private Sub Form_Load()
    ...
    If mAdd = False Then
        bind_tdb ConMain, tdbEmployee, "select employeecode,concat(lastname,', ',firstname,' ',middlename) employeename, " & _
                        ...
                        "where employeecode = " & frmAdVouchers.rsVouchers!employeecode & " order by lastname,firstname,middlename", "employeename", "employeecode"
        
        tdbEmployee.Enabled = False
        tdbEmployee.BoundText = frmAdVouchers.rsVouchers!employeecode
        txtAmount.Text = Format(frmAdVouchers.rsVouchers!amount, "#,##0.00")
        txtRemarks.Text = frmAdVouchers.rsVouchers!remarks & ""
    Else
        bind_tdb ConMain, tdbEmployee, "select employeecode,concat(lastname,', ',firstname,' ',middlename) employeename, " & _
