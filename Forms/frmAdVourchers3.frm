...
Begin VB.Form frmAdVouchers3 
   ...
   Begin VB.Frame fraButtons 
      ...
      Begin lvButton.lvButtons_H cmdMenu 
         ...
         Value           =   0   'False
         ImgAlign        =   1
         Image           =   "frmAdVourchers3.frx":0000
         ImgSize         =   24
         cBack           =   14737632
      End
      Begin lvButton.lvButtons_H cmdMenu 
         ...
         Value           =   0   'False
         ImgAlign        =   1
         Image           =   "frmAdVourchers3.frx":1CDA
         ImgSize         =   24
         cBack           =   14737632
      End
      Begin lvButton.lvButtons_H cmdMenu 
         ...
         Value           =   0   'False
         ImgAlign        =   1
         Image           =   "frmAdVourchers3.frx":39B4
         ImgSize         =   24
         cBack           =   14737632
      End
      Begin lvButton.lvButtons_H cmdMenu 
         ...
         Value           =   0   'False
         ImgAlign        =   1
         Image           =   "frmAdVourchers3.frx":568E
         ImgSize         =   24
         cBack           =   14737632
      End
      Begin lvButton.lvButtons_H cmdMenu 
         ...
         Value           =   0   'False
         ImgAlign        =   1
         Image           =   "frmAdVourchers3.frx":6368
         cBack           =   14737632
      End
   End
   Begin TrueOleDBGrid80.TDBGrid tdgVoucherValidPeriod 
      Height          =   3750
      Left            =   15
      TabIndex        =   13
      Top             =   2520
      ...
      Splits(0)._ColumnProps(31)=   "Column(4)._ColStyle=8708"
   ...
   Begin VB.Frame fraInfo 
      ...
      Top             =   645
      Width           =   12765
      Begin TDBText6Ctl.TDBText txtVoucherValidPeriodDummyCode 
         Height          =   300
         Left            =   2265
         TabIndex        =   15
         Top             =   225
         ...
         _ExtentX        =   3528
         _ExtentY        =   529
         Caption         =   "frmAdVourchers3.frx":6C42
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmAdVourchers3.frx":6CAE
         Key             =   "frmAdVourchers3.frx":6CCC
         BackColor       =   14737632
         EditMode        =   0
         ForeColor       =   4210752
         ReadOnly        =   1
      ...
      Begin TDBText6Ctl.TDBText txtDescription 
         ...
         _ExtentX        =   9525
         _ExtentY        =   529
         Caption         =   "frmAdVourchers3.frx":6D10
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmAdVourchers3.frx":6D7C
         Key             =   "frmAdVourchers3.frx":6D9A
      ...
      Begin TDBDate6Ctl.TDBDate txtStartDate 
         ...
         _ExtentX        =   2646
         _ExtentY        =   529
         Calendar        =   "frmAdVourchers3.frx":6DDE
         Caption         =   "frmAdVourchers3.frx":6EE4
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmAdVourchers3.frx":6F4A
         Keys            =   "frmAdVourchers3.frx":6F68
         Spin            =   "frmAdVourchers3.frx":6FC6
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   0
         BackColor       =   -2147483643
      ...
      Begin TDBDate6Ctl.TDBDate txtEndDate 
         ...
         _ExtentX        =   2646
         _ExtentY        =   529
         Calendar        =   "frmAdVourchers3.frx":6FEE
         Caption         =   "frmAdVourchers3.frx":70F4
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmAdVourchers3.frx":715A
         Keys            =   "frmAdVourchers3.frx":7178
         Spin            =   "frmAdVourchers3.frx":71D6
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   0
         BackColor       =   -2147483643
   ...
   Begin VB.Frame fraSearch 
      ...
      Begin TDBText6Ctl.TDBText txtSearch 
         ...
         _ExtentX        =   10186
         _ExtentY        =   529
         Caption         =   "frmAdVourchers3.frx":71FE
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmAdVourchers3.frx":726A
         Key             =   "frmAdVourchers3.frx":7288
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   -2147483640
         ReadOnly        =   0
      ...
      Begin TrueOleDBList80.TDBCombo tdbSearch 
         ...
         MaxComboItems   =   3
         AddItemSeparator=   ";"
         _PropDict       =   $"frmAdVourchers3.frx":72CC
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
   ...
   End
End
Attribute VB_Name = "frmAdVouchers3"
...
Dim rsVoucherValidPeriod          As ADODB.Recordset
...
Private Sub Form_Load()
    ...
    NetOpen rsVoucherValidPeriod, "select * from VoucherValidPeriod order by dummycode"
    
    If rsVoucherValidPeriod.RecordCount > 0 Then
      rsVoucherValidPeriod.MoveFirst
    End If
    
    Set tdgVoucherValidPeriod.DataSource = rsVoucherValidPeriod

    CreateTmpDB rsTmp
    
    With tdgVoucherValidPeriod
...
Private Sub AddSave_Button_Clicked()
    ...
    If cmdMenu(0).Caption = "&NEW" Then
        ...
        tdgVoucherValidPeriod.Enabled = False
        fraSearch.Enabled = False
        txtVoucherValidPeriodDummyCode.Text = "Auto Generated..."
    ...
    Else
        ...
        If Not IsDate(txtEndDate.Text) Then
            MsgBox "Invalid date format.", vbExclamation + vbOKCancel
            txtEndDate.SetFocus
            Exit Sub
        End If
        ...
        mCode = LastCode("VoucherValidPeriod")
        txtVoucherValidPeriodDummyCode.Text = mCode
        ConMain.Execute "insert into VoucherValidPeriod (vouchervalidperiodcode,dummycode,description,startdate,enddate) values  " & _
                          "(" & txtVoucherValidPeriodDummyCode.Text & ",'" & Format(txtVoucherValidPeriodDummyCode.Text, "0000000000") & "','" & Swap(txtDescription.Text) & "','" & Format(txtStartDate.Text, "YYYY-MM-DD") & "','" & Format(txtEndDate.Text, "YYYY-MM-DD") & "')"
        txtVoucherValidPeriodDummyCode.Text = Format(txtVoucherValidPeriodDummyCode.Text, "0000000000")
        'ConMain.Execute "insert into eventslog (modulename,actiontaken,trnxdate,usercode,username) values " & _
                          "('" & Me.Name & "','" & cmdMenu(0).Caption & " - " & txtVoucherValidPeriodDummyCode.Text & "', Now()," & UserCode & ",'" & UserName & "')"
        
        ConMain.CommitTrans
        rsVoucherValidPeriod.Requery
        rsVoucherValidPeriod.Find "vouchervalidperiodcode = " & mCode & ""
...
Private Sub EditUpdate_Button_Clicked()
    ...
    Else
        ...
        mCode = rsVoucherValidPeriod!vouchervalidperiodcode
        ConMain.Execute "update VoucherValidPeriod set description = '" & Swap(txtDescription.Text) & "',startdate = '" & Format(txtStartDate.Text, "YYYY-MM-DD") & "',enddate = '" & Format(txtEndDate.Text, "YYYY-MM-DD") & "'  where vouchervalidperiodcode = " & mCode & ""
        
        'ConMain.Execute "insert into eventslog (modulename,actiontaken,trnxdate,usercode,username) values " & _
                          "('" & Me.Name & "','" & cmdMenu(1).Caption & " - " & txtVoucherValidPeriodDummyCode.Text & "', Now()," & UserCode & ",'" & UserName & "')"
...
Private Sub Cancel_Clicked()
    ...
    tdgVoucherValidPeriod.Enabled = True
    fraSearch.Enabled = True
    tdgVoucherValidPeriod_RowColChange 0, 0
...
Private Sub tdbSearch_ItemChange()
    rsVoucherValidPeriod.Sort = tdbSearch.BoundText
End Sub
...
Private Sub tdgVoucherValidPeriod_HeadClick(ByVal ColIndex As Integer)
  
    If rsVoucherValidPeriod.RecordCount > 0 Then
      tdbSearch.BoundText = tdgVoucherValidPeriod.Columns(ColIndex).DataField
      rsVoucherValidPeriod.Sort = tdbSearch.BoundText
    End If
  
End Sub

Private Sub tdgVoucherValidPeriod_RowColChange(LastRow As Variant, ByVal LastCol As Integer)

  With rsVoucherValidPeriod
    If .RecordCount > 0 Then
      txtVoucherValidPeriodDummyCode.Text = !dummycode
      txtDescription.Text = !Description
        txtStartDate.Text = Format(!startdate, "MM/DD/YYYY")
        txtEndDate.Text = Format(!enddate, "MM/DD/YYYY")
    Else
      ClearText
    End If
  End With
...
Private Sub txtVoucherValidPeriodDummyCode_Keypress(Keyascii As Integer)
    If Keyascii = 13 Then
        SendKeys "{TAB}"
    End If
End Sub
...
Private Sub txtSearch_KeyPress(Keyascii As Integer)
  If Keyascii = 13 Then
    SendKeys "{TAB}"
  Else
    SearchRecord Keyascii, txtSearch, rsVoucherValidPeriod, txtSearch.Text, tdbSearch.BoundText
  End If
End Sub

Private Sub ClearText()

  txtVoucherValidPeriodDummyCode.Text = ""
  txtDescription.Text = ""
  txtStartDate.Text = ""
  txtEndDate.Text = ""
...
Private Sub Form_Resize()
    ...
    With fraButtons
        .Top = tdgVoucherValidPeriod.Top + tdgVoucherValidPeriod.Height
        .Left = 50
        .Width = Me.ScaleWidth - 75
    End With
