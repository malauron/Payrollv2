...
Begin VB.Form frmGenPayroll 
   ...
   Begin VB.Frame fra1 
      ...
      Begin VB.CommandButton cmdImport 
         ...
         Width           =   2025
      End
      Begin OsenXPCntrl.OsenXPButton cmdGenerate 
         Height          =   345
         Left            =   5445
         TabIndex        =   3
         Top             =   615
      ...
      Begin TrueOleDBList80.TDBCombo tdbEmployee 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmGenPayroll.frx":001C
      ...
      Begin TrueOleDBList80.TDBCombo tdbPayrollPeriod 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmGenPayroll.frx":00C6
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
   ...
   Begin CitronSoftwarePayroll.b8ChildTitleBar TitleBar 
      ...
      GradTheme       =   2
   End
   Begin TrueOleDBGrid80.TDBGrid tdgPayroll 
      Height          =   3060
      Left            =   195
      TabIndex        =   1
      Top             =   1455
   ...
   End
End
Attribute VB_Name = "frmGenPayroll"
