...
Begin VB.Form frmLOBBusiness 
   ...
   Begin VB.Frame fra1 
      ...
      Begin TDBText6Ctl.TDBText txtSearch 
         ...
         _ExtentX        =   6879
         _ExtentY        =   529
         Caption         =   "frmLOBBusiness.frx":0000
         ...
         EndProperty
         DropDown        =   "frmLOBBusiness.frx":006C
         Key             =   "frmLOBBusiness.frx":008A
      ...
      Begin TrueOleDBList80.TDBCombo tdbSort 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmLOBBusiness.frx":00CE
      ...
      End
   End
   Begin TrueOleDBGrid80.TDBGrid tdgOBT 
      Height          =   4410
      Left            =   60
      TabIndex        =   0
      Top             =   1830
   ...
   End
End
Attribute VB_Name = "frmLOBBusiness"
...
Public rsOBT        As ADODB.Recordset

Private Sub cmdmenu_Click(Index As Integer)
  
  Select Case Index
    Case 0:
            frmLOBBusiness2.mAdd = True
            frmLOBBusiness2.Show vbModal
    Case 1:
            frmLOBBusiness2.mAdd = False
            frmLOBBusiness2.Show vbModal
...
Private Sub Form_Load()
    ...
    NetOpen rsOBT, "select x1.*,concat(x2.lastname,', ',x2.firstname,' ',x2.middlename) fullname, " & _
...
Private Sub Form_Resize()
    ...
    With fra1
      .Top = fraButton.Height + fraButton.Height
      .Left = 0
      .Width = Me.ScaleWidth
    End With
...
Private Sub txtSearch_KeyPress(KeyAscii As Integer)
  If KeyAscii = 13 Then
    SendKeys "{TAB}"
  Else
    SearchRecord KeyAscii, txtSearch, rsOBT.DataSource, txtSearch.Text, tdbSort.BoundText
  End If
End Sub
