...
Begin VB.Form frmLOBUndertime 
   ...
   Begin TrueOleDBGrid80.TDBGrid tdgUndertime 
      Height          =   4095
      Left            =   60
      TabIndex        =   5
      Top             =   1650
      ...
      Columns(1).Caption=   "Date Filed"
      Columns(1).DataField=   "datefiled"
      Columns(1).NumberFormat=   "MM/DD/YYYY"
      Columns(1)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(2)._VlistStyle=   0
      Columns(2)._MaxComboItems=   5
      Columns(2).Caption=   "Reason/Purpose"
      Columns(2).DataField=   "remarks"
      ...
      Splits(0)._ColumnProps(1)=   "Column(0).Width=3625"
      Splits(0)._ColumnProps(2)=   "Column(0).DividerColor=0"
      Splits(0)._ColumnProps(3)=   "Column(0)._WidthInPix=3545"
   ...
   Begin VB.Frame fra1 
      ...
      Begin TDBText6Ctl.TDBText txtSearch 
         ...
         _ExtentX        =   6879
         _ExtentY        =   529
         Caption         =   "frmLOBUndertime.frx":0000
         ...
         EndProperty
         DropDown        =   "frmLOBUndertime.frx":006C
         Key             =   "frmLOBUndertime.frx":008A
      ...
      Begin TrueOleDBList80.TDBCombo tdbSort 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmLOBUndertime.frx":00CE
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
   ...
   End
End
Attribute VB_Name = "frmLOBUndertime"
...
Public rsUndertime     As ADODB.Recordset

Private Sub cmdmenu_Click(Index As Integer)
  
  Select Case Index
    Case 0:
            frmLOBUndertime2.mAdd = True
            frmLOBUndertime2.Show vbModal
    Case 1:
            frmLOBUndertime2.mAdd = False
            frmLOBUndertime2.Show vbModal
...
Private Sub Form_Load()
    ...
    NetOpen rsUndertime, "select x1.*,concat(x2.lastname,', ',x2.firstname,' ',x2.middlename) fullname, " & _
    ...
    Set tdgUndertime.DataSource = rsUndertime
    
    If rsUndertime.RecordCount > 0 Then
    ...
    With rsTmp
      For I = 1 To 3
        ...
        Select Case I
          ...
          Case 2: .Fields("code") = "datefiled"
                  .Fields("description") = "Date Filed"
          Case 3: .Fields("code") = "remarks"
                  .Fields("description") = "Reason/Purpose"
        End Select
        .Update
      Next
    End With
...
Private Sub tdbSort_ItemChange()
  rsUndertime.Sort = tdbSort.BoundText
End Sub
...
Private Sub txtSearch_KeyPress(KeyAscii As Integer)
  If KeyAscii = 13 Then
    SendKeys "{TAB}"
  Else
    SearchRecord KeyAscii, txtSearch, rsUndertime.DataSource, txtSearch.Text, tdbSort.BoundText
  End If
End Sub
