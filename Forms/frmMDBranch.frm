...
Begin VB.Form frmMDBranch 
   ...
   Begin VB.Frame fraButtons 
      ...
      Begin lvButton.lvButtons_H cmdMenu 
         ...
         Value           =   0   'False
         ImgAlign        =   1
         Image           =   "frmMDBranch.frx":6368
         cBack           =   14737632
      End
   End
   Begin TrueOleDBGrid80.TDBGrid tdgBranch 
      Height          =   3750
      Left            =   15
      TabIndex        =   8
      Top             =   2625
   ...
   Begin VB.Frame fraInfo 
      ...
      Top             =   630
      Width           =   12765
      Begin TDBText6Ctl.TDBText txtBranchDummyCode 
         Height          =   300
         Left            =   2265
         TabIndex        =   10
         Top             =   225
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMDBranch.frx":6CAE
         Key             =   "frmMDBranch.frx":6CCC
         BackColor       =   14737632
         EditMode        =   0
         ForeColor       =   4210752
         ReadOnly        =   1
         ...
         OLEDropMode     =   0
      End
      Begin TDBText6Ctl.TDBText txtBranchname 
         Height          =   300
         Left            =   2265
         TabIndex        =   11
         Top             =   570
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMDBranch.frx":6D7C
         Key             =   "frmMDBranch.frx":6D9A
         ...
         OLEDropMode     =   0
      End
      Begin TDBText6Ctl.TDBText txtBranchDescription 
         Height          =   300
         Left            =   2265
         TabIndex        =   12
         Top             =   915
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMDBranch.frx":6E4A
         Key             =   "frmMDBranch.frx":6E68
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   4210752
         ReadOnly        =   0
   ...
   Begin VB.Frame fraSearch 
      ...
      Begin TDBText6Ctl.TDBText txtSearch 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMDBranch.frx":6F18
         Key             =   "frmMDBranch.frx":6F36
         BackColor       =   -2147483643
         EditMode        =   0
      ...
      Begin TrueOleDBList80.TDBCombo tdbSearch 
         ...
         MaxComboItems   =   3
         AddItemSeparator=   ";"
         _PropDict       =   $"frmMDBranch.frx":6F7A
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
...
'Dim mBranchSortField    As String
'
...
'
'    With gridBranch
'        .Top = fraBranch.Top + fraBranch.Height
'        .Left = 0
'        .Width = Me.ScaleWidth
...
'
'    DoEvents
'    NetOpen branch, "select * from Branch order by Branchcode"
'    DoEvents
'    If branch.State = adStateOpen Then
...
'        End If
'        Set gridBranch.DataSource = branch
'        mBranchSortField = "Branch"
'    End If
'
'End Sub
'
...
'    txtBranchCode.Text = "AUTO GENERATED..."
'    txtBranchName.Text = ""
'    txtDescription.Text = ""
'End Sub
'
...
'        gridBranch.Enabled = False
'        txtSearchBoxBranch.Enabled = False
'        Call ClearFields
'        SafeSetFocus txtBranchName
'    Else
'        If txtBranchName.Text = "" Then
'            MsgBox "You need to specify the branch name.", vbInformation
'            SafeSetFocus txtBranchName
'            Exit Sub
'        End If
...
'        ConMain.BeginTrans
'            mTransActive = True
'            txtBranchCode.Text = LastCode("Branch")
'            ConMain.Execute "insert into Branch values (" & txtBranchCode.Text & ",'" & Format(txtBranchCode.Text, "00000000") & "', '" & CSQ(txtBranchName.Text) & "', '" & CSQ(txtDescription.Text) & "')"
'        ConMain.CommitTrans
'        gridBranch.Enabled = True
'        fraBranch.Enabled = False
'        txtSearchBoxBranch.Enabled = True
'        mCode = txtBranchCode.Text
'        branch.Requery
'        pointmetdg gridBranch, branch, "BranchCode", mCode
'        mAdd = False
'        mTransActive = False
'        cmdMenu(0).Caption = "&New"
'        Lock_Button "TTTFTT", cmdMenu, 5
'        txtBranchCode.Text = Format(txtBranchCode.Text, "00000000")
'    End If
'End Sub
'
'
...
'        ConMain.BeginTrans
'        mTransActive = True
'        ConMain.Execute "update Branch set Branch = '" & CSQ(txtBranchName.Text) & "',  description = '" & CSQ(txtDescription.Text) & "' where Branchcode = '" & branch!branchcode & "'"
'        ConMain.CommitTrans
'        gridBranch.Enabled = True
'        fraBranch.Enabled = False
'        txtSearchBoxBranch.Enabled = True
...
'    txtSearchBoxBranch.Enabled = True
'    gridBranch.Enabled = True
'    gridBranch_RowColChange gridBranch.Row, gridBranch.Col
'End Sub
'
...
'End Sub
'
'Private Sub gridBranch_HeadClick(ByVal ColIndex As Integer)
'    If branch.RecordCount > 0 Then
'        mBranchSortField = gridBranch.Columns(ColIndex).DataField
'        branch.Sort = mBranchSortField
'    End If
'End Sub
'
'Private Sub gridBranch_RowColChange(LastRow As Variant, ByVal LastCol As Integer)
'
'    With branch
'        If .RecordCount > 0 Then
'            txtBranchCode.Text = !dummycode & ""
...
'End Sub
'
'Private Sub txtSearchBoxBranch_KeyPress(Keyascii As Integer)
'    If Keyascii = 13 Then
'        SendKeys "{TAB}"
'    Else
'        SearchRecord Keyascii, txtSearchBoxBranch, branch, txtSearchBoxBranch.Text, mBranchSortField
'    End If
'End Sub
...
Private Sub Form_Load()
    ...
    NetOpen rsBranch, "select * from Branch order by dummycode"
    If rsBranch.RecordCount > 0 Then
      rsBranch.MoveFirst
    End If
    Set tdgBranch.DataSource = rsBranch

    CreateTmpDB rsTmp
    
    With tdgBranch
        For i = .Columns("dummycode").ColIndex To .Columns("branch").ColIndex
...
Private Sub AddSave_Button_Clicked()
    ...
    If cmdMenu(0).Caption = "&NEW" Then
        ...
        tdgBranch.Enabled = False
        fraSearch.Enabled = False
        txtBranchDummyCode.Text = "Auto Generated..."
    ...
    Else
        ...
        NetOpen rsCheck, "select * from Branch where branch = '" & Swap(txtBranchname.Text) & "'"
        
        If rsCheck.RecordCount > 0 Then
            If MsgBox("Branch name already in taken. Would you like to continue saving this entry?", vbQuestion + vbYesNo) = vbNo Then
                Exit Sub
            End If
        End If
        ...
        ConMain.Execute "set autocommit = 0"
        ConMain.BeginTrans
        mCode = LastCode("Branch")
        txtBranchDummyCode.Text = mCode
        ConMain.Execute "insert into Branch (Branchcode,dummycode,branch,description) values  " & _
                          "(" & txtBranchDummyCode.Text & ",'" & Format(txtBranchDummyCode.Text, "00000000") & "','" & Swap(txtBranchname.Text) & "','" & Swap(txtBranchDescription.Text) & "')"
        
        txtBranchDummyCode.Text = Format(txtBranchDummyCode.Text, "00000000")
      
        ConMain.CommitTrans
        rsBranch.Requery
        rsBranch.Find "Branchcode = " & mCode & ""
...
Private Sub EditUpdate_Button_Clicked()
    ...
    Else
        ...
        mCode = rsBranch!branchcode
        
        NetOpen rsCheck, "select * from Branch where Branchcode <> " & mCode & " and branch = '" & Swap(txtBranchname.Text) & "'"
        ...
        ConMain.Execute "update Branch set branch = '" & Swap(txtBranchname.Text) & "',description = '" & Swap(txtBranchDescription.Text) & "'  where Branchcode = " & mCode & ""
'        ConMain.Execute "insert into eventslog (modulename,actiontaken,trnxdate,usercode,username) values " & _
                          "('" & Me.Name & "','" & cmdMenu(1).Caption & " - " & txtBranchDummyCode.Text & "', Now()," & UserCode & ",'" & UserName & "')"
...
Private Sub Cancel_Clicked()
  ...
  cmdMenu(1).Caption = "&EDIT"
    ...
    tdgBranch.Enabled = True
    fraSearch.Enabled = True
    tdgBranch_RowColChange 0, 0
...
Private Sub tdbSearch_ItemChange()
    rsBranch.Sort = tdbSearch.BoundText
End Sub
...
Private Sub tdgBranch_HeadClick(ByVal ColIndex As Integer)
  
    If rsBranch.RecordCount > 0 Then
      tdbSearch.BoundText = tdgBranch.Columns(ColIndex).DataField
      rsBranch.Sort = tdbSearch.BoundText
    End If
  
End Sub

Private Sub tdgBranch_RowColChange(LastRow As Variant, ByVal LastCol As Integer)

  With rsBranch
    If .RecordCount > 0 Then
      txtBranchDummyCode.Text = !dummycode
      txtBranchname.Text = !branch
      txtBranchDescription.Text = !Description
    Else
      ClearText
    End If
  End With
...
Private Sub txtBranchDescription_Keypress(KeyAscii As Integer)
    If KeyAscii = 13 Then
...
Private Sub txtBranchDummyCode_Keypress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        SendKeys "{TAB}"
    End If
End Sub
...
Private Sub txtSearch_KeyPress(KeyAscii As Integer)
  If KeyAscii = 13 Then
    SendKeys "{TAB}"
  Else
    SearchRecord KeyAscii, txtSearch, rsBranch, txtSearch.Text, tdbSearch.BoundText
  End If
End Sub

Private Sub ClearText()

  txtBranchDummyCode.Text = ""
  txtBranchname.Text = ""
...
Private Sub Form_Resize()
    ...
    With fraButtons
        .Top = tdgBranch.Top + tdgBranch.Height
        .Left = 50
        .Width = Me.ScaleWidth - 75
    End With
