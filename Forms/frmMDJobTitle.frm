...
Begin VB.Form frmMDJobTitle 
   ...
   Begin VB.PictureBox pic1 
      ...
      End
   End
   Begin TrueOleDBGrid80.TDBGrid tdgJobTitle 
      Height          =   3750
      Left            =   15
      TabIndex        =   8
      Top             =   2625
   ...
   Begin VB.Frame fraInfo 
      ...
      Top             =   630
      Width           =   12765
      Begin TDBText6Ctl.TDBText txtJobTitleDummyCode 
         Height          =   300
         Left            =   2265
         TabIndex        =   10
         Top             =   375
         ...
         _ExtentX        =   3528
         _ExtentY        =   529
         Caption         =   "frmMDJobTitle.frx":6C42
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMDJobTitle.frx":6CAE
         Key             =   "frmMDJobTitle.frx":6CCC
         BackColor       =   14737632
         EditMode        =   0
         ForeColor       =   4210752
         ReadOnly        =   1
         ...
         OLEDropMode     =   0
      End
      Begin TDBText6Ctl.TDBText txtJobTitlename 
         Height          =   300
         Left            =   8400
         TabIndex        =   11
         Top             =   375
         ...
         _ExtentX        =   9525
         _ExtentY        =   529
         Caption         =   "frmMDJobTitle.frx":6D10
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMDJobTitle.frx":6D7C
         Key             =   "frmMDJobTitle.frx":6D9A
         ...
         OLEDropMode     =   0
      End
      Begin TDBText6Ctl.TDBText txtJobTitleDescription 
         Height          =   300
         Left            =   2265
         TabIndex        =   12
         Top             =   720
         ...
         _ExtentX        =   9525
         _ExtentY        =   529
         Caption         =   "frmMDJobTitle.frx":6DDE
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMDJobTitle.frx":6E4A
         Key             =   "frmMDJobTitle.frx":6E68
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   4210752
         ReadOnly        =   0
   ...
   Begin VB.Frame fraSearch 
      ...
      Begin TDBText6Ctl.TDBText txtSearch 
         ...
         _ExtentX        =   10186
         _ExtentY        =   529
         Caption         =   "frmMDJobTitle.frx":6EAC
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMDJobTitle.frx":6F18
         Key             =   "frmMDJobTitle.frx":6F36
         BackColor       =   -2147483643
         EditMode        =   0
      ...
      Begin TrueOleDBList80.TDBCombo tdbSearch 
         ...
         MaxComboItems   =   3
         AddItemSeparator=   ";"
         _PropDict       =   $"frmMDJobTitle.frx":6F7A
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
   ...
   End
End
Attribute VB_Name = "frmMDJobTitle"
...
Private Sub Form_Load()
    ...
    NetOpen rsJobTitle, "select * from JobTitle order by dummycode"
    If rsJobTitle.RecordCount > 0 Then
      rsJobTitle.MoveFirst
    End If
    Set tdgJobTitle.DataSource = rsJobTitle
...
Private Sub AddSave_Button_Clicked()
    ...
    If cmdMenu(0).Caption = "&NEW" Then
        ...
        txtJobTitleDescription.SetFocus
        tdgJobTitle.Enabled = False
        fraSearch.Enabled = False
        txtJobTitleDummyCode.Text = "Auto Generated..."
    
    Else
    
'        If Trim(txtJobTitlename.Text) = "" Then
'            MsgBox "Room Type name is blank.", vbExclamation + vbOKOnly
'            txtJobTitlename.SetFocus
'            Exit Sub
'        End If
        
        NetOpen rsCheck, "select * from JobTitle where description = '" & Swap(txtJobTitlename.Text) & "'"
        
        If rsCheck.RecordCount > 0 Then
            If MsgBox("Job Title name already taken. Would you like to continue saving this entry?", vbQuestion + vbYesNo) = vbNo Then
                Exit Sub
            End If
        End If
        ...
        ConMain.BeginTrans
        mCode = LastCode("JobTitle")
        txtJobTitleDummyCode.Text = mCode
        ConMain.Execute "insert into JobTitle (JobTitlecode,dummycode,description) values  " & _
                          "(" & txtJobTitleDummyCode.Text & ",'" & Format(txtJobTitleDummyCode.Text, "00000000") & "','" & Swap(txtJobTitleDescription.Text) & "')"
        
        txtJobTitleDummyCode.Text = Format(txtJobTitleDummyCode.Text, "00000000")
      
        ConMain.CommitTrans
        rsJobTitle.Requery
        rsJobTitle.Find "JobTitlecode = " & mCode & ""
...
'        End If
        ...
        mCode = rsJobTitle!jobtitlecode
        
        NetOpen rsCheck, "select * from JobTitle where JobTitlecode <> " & mCode & " and description = '" & Swap(txtJobTitlename.Text) & "'"
        ...
        ConMain.Execute "update JobTitle set description = '" & Swap(txtJobTitleDescription.Text) & "'  where JobTitlecode = " & mCode & ""
'        ConMain.Execute "insert into eventslog (modulename,actiontaken,trnxdate,usercode,username) values " & _
                          "('" & Me.Name & "','" & cmdMenu(1).Caption & " - " & txtJobTitleDummyCode.Text & "', Now()," & UserCode & ",'" & UserName & "')"
...
Private Sub Cancel_Clicked()
  ...
  cmdMenu(1).Caption = "&EDIT"
    ...
    tdgJobTitle.Enabled = True
    fraSearch.Enabled = True
    tdgJobTitle_RowColChange 0, 0
...
Private Sub tdbSearch_ItemChange()
    rsJobTitle.Sort = tdbSearch.BoundText
End Sub
...
Private Sub tdgJobTitle_HeadClick(ByVal ColIndex As Integer)
  
    If rsJobTitle.RecordCount > 0 Then
      tdbSearch.BoundText = tdgJobTitle.Columns(ColIndex).DataField
      rsJobTitle.Sort = tdbSearch.BoundText
    End If
  
End Sub

Private Sub tdgJobTitle_RowColChange(LastRow As Variant, ByVal LastCol As Integer)

  With rsJobTitle
    If .RecordCount > 0 Then
      txtJobTitleDummyCode.Text = !dummycode
      'txtJobTitlename.Text = !jobtitle
      txtJobTitleDescription.Text = !Description
    Else
      ClearText
    End If
  End With
...
Private Sub txtJobTitleDescription_Keypress(KeyAscii As Integer)
    If KeyAscii = 13 Then
...
Private Sub txtJobTitleDummyCode_Keypress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        SendKeys "{TAB}"
    End If
End Sub

Private Sub txtJobTitleName_Keypress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        SendKeys "{TAB}"
    End If
End Sub
...
Private Sub txtSearch_KeyPress(KeyAscii As Integer)
  If KeyAscii = 13 Then
    SendKeys "{TAB}"
  Else
    SearchRecord KeyAscii, txtSearch, rsJobTitle, txtSearch.Text, tdbSearch.BoundText
  End If
End Sub

Private Sub ClearText()

  txtJobTitleDummyCode.Text = ""
...
Private Sub Form_Resize()
    ...
    With fraButtons
        .Top = tdgJobTitle.Top + tdgJobTitle.Height
        .Left = 50
        .Width = Me.ScaleWidth - 75
    End With
