...
Begin VB.Form frmMDLoanTypes 
   ...
   Begin VB.Frame fraSearch 
      ...
      Begin TDBText6Ctl.TDBText txtSearch 
         ...
         _ExtentX        =   10186
         _ExtentY        =   529
         Caption         =   "frmMDLoanTypes.frx":6852
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMDLoanTypes.frx":68BE
         Key             =   "frmMDLoanTypes.frx":68DC
      ...
      Begin TrueOleDBList80.TDBCombo tdbSearch 
         ...
         MaxComboItems   =   3
         AddItemSeparator=   ";"
         _PropDict       =   $"frmMDLoanTypes.frx":6920
   ...
   Begin VB.PictureBox pic1 
      ...
      Begin VB.Label label1 
         BackStyle       =   0  'Transparent
         Caption         =   "Master data - Loan Types"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   12
            Charset         =   0
      ...
      End
   End
   Begin TrueOleDBGrid80.TDBGrid tdgLoanTypes 
      Height          =   3750
      Left            =   15
      TabIndex        =   8
      Top             =   2625
   ...
   Begin VB.Frame fraInfo 
      ...
      Top             =   630
      Width           =   12765
      Begin TDBText6Ctl.TDBText txtLoanTypesDummyCode 
         Height          =   300
         Left            =   2265
         TabIndex        =   10
         Top             =   225
         ...
         _ExtentX        =   3528
         _ExtentY        =   529
         Caption         =   "frmMDLoanTypes.frx":D60C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMDLoanTypes.frx":D678
         Key             =   "frmMDLoanTypes.frx":D696
         BackColor       =   14737632
         EditMode        =   0
         ForeColor       =   4210752
         ReadOnly        =   1
         ...
         OLEDropMode     =   0
      End
      Begin TDBText6Ctl.TDBText txtLoantypesName 
         Height          =   300
         Left            =   2265
         TabIndex        =   11
         Top             =   570
         ...
         _ExtentX        =   9525
         _ExtentY        =   529
         Caption         =   "frmMDLoanTypes.frx":D6DA
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMDLoanTypes.frx":D746
         Key             =   "frmMDLoanTypes.frx":D764
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   4210752
         ReadOnly        =   0
      ...
      Begin TDBText6Ctl.TDBText txtDescription 
         ...
         _ExtentX        =   9525
         _ExtentY        =   529
         Caption         =   "frmMDLoanTypes.frx":D7A8
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMDLoanTypes.frx":D814
         Key             =   "frmMDLoanTypes.frx":D832
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   4210752
         ReadOnly        =   0
   ...
   End
End
Attribute VB_Name = "frmMDLoanTypes"
...
Dim rsLoanTypes          As ADODB.Recordset
...
Private Sub Form_Load()
    ...
    NetOpen rsLoanTypes, "select * from LoanTypes order by dummycode"
    If rsLoanTypes.RecordCount > 0 Then
      rsLoanTypes.MoveFirst
    End If
    Set tdgLoanTypes.DataSource = rsLoanTypes
...
Private Sub AddSave_Button_Clicked()
    ...
    If cmdMenu(0).Caption = "&NEW" Then
        ...
        txtLoantypesName.SetFocus
        tdgLoanTypes.Enabled = False
        fraSearch.Enabled = False
        txtLoanTypesDummyCode.Text = "Auto Generated..."
    
    Else
    
        If Trim(txtLoantypesName.Text) = "" Then
        ...
        mCode = LastCode("LoanTypes")
        txtLoanTypesDummyCode.Text = mCode
        ConMain.Execute "insert into LoanTypes (LoanTypescode,dummycode,LoanTypesname,description) values  " & _
                          "(" & txtLoanTypesDummyCode.Text & ",'" & Format(txtLoanTypesDummyCode.Text, "0000000000") & "','" & Swap(txtLoantypesName.Text) & "','" & Swap(txtDescription.Text) & "')"
        txtLoanTypesDummyCode.Text = Format(txtLoanTypesDummyCode.Text, "0000000000")
        'ConMain.Execute "insert into eventslog (modulename,actiontaken,trnxdate,usercode,username) values " & _
                          "('" & Me.Name & "','" & cmdMenu(0).Caption & " - " & txtLoanTypesDummyCode.Text & "', Now()," & UserCode & ",'" & UserName & "')"
        
        ConMain.CommitTrans
        rsLoanTypes.Requery
        rsLoanTypes.Find "LoanTypescode = " & mCode & ""
...
Private Sub EditUpdate_Button_Clicked()
    ...
    Else
        ...
        mCode = rsLoanTypes!loantypescode
        ConMain.Execute "update LoanTypes set LoanTypesname = '" & Swap(txtLoantypesName.Text) & "',description = '" & Swap(txtDescription.Text) & "'  where LoanTypescode = " & mCode & ""
        'ConMain.Execute "insert into eventslog (modulename,actiontaken,trnxdate,usercode,username) values " & _
                          "('" & Me.Name & "','" & cmdMenu(1).Caption & " - " & txtLoanTypesDummyCode.Text & "', Now()," & UserCode & ",'" & UserName & "')"
...
Private Sub Cancel_Clicked()
  ...
  cmdMenu(1).Caption = "&EDIT"
    ...
    tdgLoanTypes.Enabled = True
    fraSearch.Enabled = True
    tdgLoanTypes_RowColChange 0, 0
...
Private Sub tdbSearch_ItemChange()
    rsLoanTypes.Sort = tdbSearch.BoundText
End Sub
...
Private Sub tdgLoanTypes_HeadClick(ByVal ColIndex As Integer)
  
    If rsLoanTypes.RecordCount > 0 Then
      tdbSearch.BoundText = tdgLoanTypes.Columns(ColIndex).DataField
      rsLoanTypes.Sort = tdbSearch.BoundText
    End If
  
End Sub

Private Sub tdgLoanTypes_RowColChange(LastRow As Variant, ByVal LastCol As Integer)

  With rsLoanTypes
    If .RecordCount > 0 Then
      txtLoanTypesDummyCode.Text = !dummycode
      txtLoantypesName.Text = !loantypesname
...
Private Sub txtLoanTypesDummyCode_Keypress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        SendKeys "{TAB}"
    End If
End Sub

Private Sub txtLoanTypesName_Keypress(KeyAscii As Integer)
    If KeyAscii = 13 Then
        SendKeys "{TAB}"
    End If
End Sub
...
Private Sub txtSearch_KeyPress(KeyAscii As Integer)
  If KeyAscii = 13 Then
    SendKeys "{TAB}"
  Else
    SearchRecord KeyAscii, txtSearch, rsLoanTypes, txtSearch.Text, tdbSearch.BoundText
  End If
End Sub

Private Sub ClearText()

  txtLoanTypesDummyCode.Text = ""
  txtLoantypesName.Text = ""
  txtDescription.Text = ""
...
Private Sub Form_Resize()
    ...
    With fraButtons
        .Top = tdgLoanTypes.Top + tdgLoanTypes.Height
        .Left = 50
        .Width = Me.ScaleWidth - 75
    End With
