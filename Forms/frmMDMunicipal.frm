...
Begin VB.Form frmMDMunicipal 
   ...
   Begin VB.Frame fraInfo 
      ...
      Top             =   1980
      Width           =   7125
      Begin TDBText6Ctl.TDBText txtMunCode 
         Height          =   300
         Left            =   1560
         TabIndex        =   7
         Top             =   255
         ...
         _ExtentX        =   3528
         _ExtentY        =   529
         Caption         =   "frmMDMunicipal.frx":0000
         ...
         EndProperty
         DropDown        =   "frmMDMunicipal.frx":006C
         Key             =   "frmMDMunicipal.frx":008A
      ...
      Begin TDBText6Ctl.TDBText txtDescription 
         ...
         _ExtentX        =   9525
         _ExtentY        =   529
         Caption         =   "frmMDMunicipal.frx":00CE
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMDMunicipal.frx":013A
         Key             =   "frmMDMunicipal.frx":0158
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   -2147483640
         ReadOnly        =   0
         ...
         OLEDropMode     =   0
      End
      Begin TDBText6Ctl.TDBText txtMunName 
         Height          =   300
         Left            =   1560
         TabIndex        =   9
         Top             =   585
         ...
         _ExtentX        =   9525
         _ExtentY        =   529
         Caption         =   "frmMDMunicipal.frx":019C
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMDMunicipal.frx":0208
         Key             =   "frmMDMunicipal.frx":0226
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   -2147483640
         ReadOnly        =   0
   ...
   Begin VB.Frame fraSearch 
      ...
      Begin TDBText6Ctl.TDBText txtSearch 
         ...
         _ExtentX        =   7064
         _ExtentY        =   529
         Caption         =   "frmMDMunicipal.frx":026A
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMDMunicipal.frx":02D6
         Key             =   "frmMDMunicipal.frx":02F4
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   -2147483640
         ReadOnly        =   0
   ...
   Begin VB.Frame fraCategory 
      ...
      Begin TrueOleDBList80.TDBCombo tdbProvince 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmMDMunicipal.frx":0338
      ...
      End
   End
   Begin TrueOleDBGrid80.TDBGrid tdgMunicipal 
      Height          =   2310
      Left            =   90
      TabIndex        =   13
      Top             =   3360
      ...
      Columns(0)._MaxComboItems=   5
      Columns(0).Caption=   "Code"
      Columns(0).DataField=   "muncode"
      Columns(0)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(1)._VlistStyle=   0
      Columns(1)._MaxComboItems=   5
      Columns(1).Caption=   "Municipal"
      Columns(1).DataField=   "munname"
      Columns(1)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
   ...
   End
End
Attribute VB_Name = "frmMDMunicipal"
...
Dim rsMunicipal             As ADODB.Recordset
Dim mSort                  As String
...
Private Sub Form_Load()
    ...
    If tdbProvince.ApproxCount > 0 Then
      ...
      NetOpen rsMunicipal, "select x1.*,x2.provname  from municipal x1 " & _
                               "left outer join province x2 on x1.provcode = x2.provcode " & _
                               "where x1.provcode = '" & tdbProvince.Columns(0).Text & "' order by x1.muncode"
    End If
    If rsMunicipal.RecordCount > 0 Then
      rsMunicipal.MoveFirst
    End If
    Set tdgMunicipal.DataSource = rsMunicipal
    mSort = "muncode"
...
Private Sub AddSave_Button_Clicked()
  ...
  Else
    ...
    ConMain.BeginTrans
    txtMunCode.Text = LastCode("Municipal")
    ConMain.Execute "insert into municipal (provcode,muncode,munname,description) values('" & tdbProvince.BoundText & "','" & txtMunCode.Text & "','" & txtMunName.Text & "','" & txtDescription.Text & "')"
    ConMain.CommitTrans
    NetOpen rsMunicipal, "select x1.*,x2.provname  from municipal x1 " & _
                             "left outer join province x2 on x1.provcode = x2.provcode " & _
                             "where x1.provcode = '" & tdbProvince.Columns(0).Text & "' order by x1.muncode"
    Set tdgMunicipal.DataSource = rsMunicipal
    rsMunicipal.Find "muncode = '" & txtMunCode.Text & "'"
...
Private Sub EditUpdate_Button_Clicked()
  ...
  Else
    ...
    ConMain.Execute "update municipal set provcode = '" & tdbProvince.BoundText & "',munname = '" & txtMunName.Text & "',description = '" & txtDescription.Text & "' where muncode = '" & txtMunCode.Text & "'"
...
Private Sub Cancel_Clicked()
  ...
  tdgMunicipal.Enabled = True
  tdgMunicipal_RowColChange 0, 0
...
Private Sub tdgMunicipal_HeadClick(ByVal ColIndex As Integer)

    If rsMunicipal.RecordCount > 0 Then
      mSort = tdgMunicipal.Columns(ColIndex).DataField
      rsMunicipal.Sort = mSort
    End If
  
End Sub

Private Sub tdgMunicipal_RowColChange(LastRow As Variant, ByVal LastCol As Integer)

  With rsMunicipal
    If .RecordCount > 0 Then
      txtMunCode.Text = !muncode
      txtMunName.Text = !munname
...
Private Sub tdbProvince_ItemChange()
  If cmdMenu(0).Caption = "&New" And cmdMenu(1).Caption = "&Edit" Then
    NetOpen rsMunicipal, "select x1.*,x2.provname  from municipal x1 " & _
                             "left outer join province x2 on x1.provcode = x2.provcode " & _
                             "where x1.provcode = '" & tdbProvince.BoundText & "' order by x1.muncode"
    Set tdgMunicipal.DataSource = rsMunicipal
  End If
End Sub
...
Private Sub txtSearch_KeyPress(KeyAscii As Integer)
  If KeyAscii = 13 Then
    SendKeys "{TAB}"
  Else
    SearchRecord KeyAscii, txtSearch, rsMunicipal, txtSearch.Text, mSort
  End If
End Sub
