...
Begin VB.Form frmMDProvince 
   ...
   Begin VB.Frame fraSearch 
      ...
      Begin TDBText6Ctl.TDBText txtSearch 
         ...
         _ExtentX        =   10186
         _ExtentY        =   529
         Caption         =   "frmMDProvince.frx":0000
         ...
         EndProperty
         DropDown        =   "frmMDProvince.frx":006C
         Key             =   "frmMDProvince.frx":008A
      ...
      Begin TrueOleDBList80.TDBCombo tdbSearch 
         ...
         MaxComboItems   =   3
         AddItemSeparator=   ";"
         _PropDict       =   $"frmMDProvince.frx":00CE
   ...
   Begin VB.Frame fraInfo 
      ...
      Top             =   630
      Width           =   12765
      Begin TDBText6Ctl.TDBText txtProvinceDummyCode 
         Height          =   300
         Left            =   2265
         TabIndex        =   10
         Top             =   225
         ...
         _ExtentX        =   3528
         _ExtentY        =   529
         Caption         =   "frmMDProvince.frx":6DBA
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMDProvince.frx":6E26
         Key             =   "frmMDProvince.frx":6E44
         BackColor       =   14737632
         EditMode        =   0
         ForeColor       =   4210752
         ReadOnly        =   1
      ...
      Begin TDBText6Ctl.TDBText txtProvname 
         ...
         _ExtentX        =   9525
         _ExtentY        =   529
         Caption         =   "frmMDProvince.frx":6E88
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMDProvince.frx":6EF4
         Key             =   "frmMDProvince.frx":6F12
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   4210752
         ReadOnly        =   0
      ...
      Begin TDBText6Ctl.TDBText txtDescription 
         ...
         _ExtentX        =   9525
         _ExtentY        =   529
         Caption         =   "frmMDProvince.frx":6F56
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmMDProvince.frx":6FC2
         Key             =   "frmMDProvince.frx":6FE0
         BackColor       =   -2147483643
         EditMode        =   0
         ForeColor       =   4210752
         ReadOnly        =   0
   ...
   End
End
Attribute VB_Name = "frmMDProvince"
...
Private Sub Form_Load()
    ...
    NetOpen rsProvince, "select * from Province order by dummycode"
    ...
    With tdgProvince
        For I = .Columns("dummycode").ColIndex To .Columns("Province").ColIndex
...
Private Sub AddSave_Button_Clicked()
    ...
    If cmdMenu(0).Caption = "&NEW" Then
        ...
        txtProvinceDummyCode.Text = "Auto Generated..."
    ...
    Else
        ...
        NetOpen rsCheck, "select * from Province where Province = '" & Swap(txtProvname.Text) & "'"
        
        If rsCheck.RecordCount > 0 Then
            If MsgBox("Province name already taken. Would you like to continue saving this entry?", vbQuestion + vbYesNo) = vbNo Then
                Exit Sub
            End If
        End If
        ...
        ConMain.BeginTrans
        mCode = LastCode("Province")
        txtProvinceDummyCode.Text = mCode
        ConMain.Execute "insert into Province (Provincecode,dummycode,provname,description) values  " & _
                          "(" & txtProvinceDummyCode.Text & ",'" & Format(txtProvinceDummyCode.Text, "00000000") & "','" & Swap(txtProvname.Text) & "','" & Swap(txtDescription.Text) & "')"
        
        txtProvinceDummyCode.Text = Format(txtProvinceDummyCode.Text, "00000000")
      
        ConMain.CommitTrans
        rsProvince.Requery
        rsProvince.Find "Provincecode = " & mCode & ""
...
Private Sub EditUpdate_Button_Clicked()
    ...
    Else
        ...
        mCode = rsProvince!Provincecode
        
        NetOpen rsCheck, "select * from Province where Provincecode <> " & mCode & " and Province = '" & Swap(txtProvname.Text) & "'"
        ...
        ConMain.Execute "update Province set provname = '" & Swap(txtProvname.Text) & "',description = '" & Swap(txtDescription.Text) & "'  where Provincecode = " & mCode & ""
'       ConMain.Execute "insert into eventslog (modulename,actiontaken,trnxdate,usercode,username) values " & _
                          "('" & Me.Name & "','" & cmdMenu(1).Caption & " - " & txtProvinceDummyCode.Text & "', Now()," & UserCode & ",'" & UserName & "')"
...
Private Sub tdbSearch_ItemChange()
    rsProvince.Sort = tdbSearch.BoundText
End Sub
...
Private Sub tdgProvince_HeadClick(ByVal ColIndex As Integer)
    If rsProvince.RecordCount > 0 Then
      tdbSearch.BoundText = tdgProvince.Columns(ColIndex).DataField
      rsProvince.Sort = tdbSearch.BoundText
    End If
End Sub
...
Private Sub tdgProvince_RowColChange(LastRow As Variant, ByVal LastCol As Integer)
  With rsProvince
    If .RecordCount > 0 Then
      txtProvinceDummyCode.Text = !dummycode
      txtProvname.Text = !province
...
Private Sub txtProvinceDummyCode_Keypress(Keyascii As Integer)
    If Keyascii = 13 Then
        SendKeys "{TAB}"
    End If
End Sub
...
Private Sub txtSearch_KeyPress(Keyascii As Integer)
  If Keyascii = 13 Then
    SendKeys "{TAB}"
  Else
    SearchRecord Keyascii, txtSearch, rsProvince, txtSearch.Text, tdbSearch.BoundText
  End If
End Sub

Private Sub ClearText()

  txtProvinceDummyCode.Text = ""
  txtProvname.Text = ""
  txtDescription.Text = ""
...
Private Sub Form_Resize()
    ...
    With fraButtons
        .Top = tdgProvince.Top + tdgProvince.Height
        .Left = 50
        .Width = Me.ScaleWidth - 75
    End With
