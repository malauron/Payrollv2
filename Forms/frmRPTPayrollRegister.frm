...
Begin VB.Form frmRPTPayrollRegister 
   BackColor       =   &H00F6F8F8&
   ClientHeight    =   9855
   ClientLeft      =   60
   ClientTop       =   60
   ...
   Begin VB.Frame fraParmtr 
      ...
      Begin VB.Frame Frame1 
         ...
         Top             =   150
         Width           =   3225
         Begin VB.OptionButton optDivisionSum 
            Appearance      =   0  'Flat
            BackColor       =   &H00F6F8F8&
            Caption         =   "Division Summary"
            BeginProperty Font 
               Name            =   "Tahoma"
               Size            =   8.25
               Charset         =   0
            ...
            Width           =   2595
         End
         Begin VB.OptionButton optCostCenterSum 
            Appearance      =   0  'Flat
            BackColor       =   &H00F6F8F8&
            Caption         =   "Cost Center Summary"
            BeginProperty Font 
               Name            =   "Tahoma"
               Size            =   8.25
               Charset         =   0
      ...
      Begin TrueOleDBList80.TDBCombo tdbPayrollPeriod 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRPTPayrollRegister.frx":0000
      ...
      Begin TrueOleDBList80.TDBCombo tdbEmployee 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRPTPayrollRegister.frx":00AA
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin OsenXPCntrl.OsenXPButton cmdView 
         ...
         MCOL            =   12632256
         MPTR            =   0
         MICON           =   "frmRPTPayrollRegister.frx":0154
         PICN            =   "frmRPTPayrollRegister.frx":0170
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin TrueOleDBList80.TDBCombo tdbCostCenter 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRPTPayrollRegister.frx":070A
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin TrueOleDBList80.TDBCombo tdbDivision 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRPTPayrollRegister.frx":07B4
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
   ...
   End
End
Attribute VB_Name = "frmRPTPayrollRegister"
...
Private Sub cmdView_Click()
    ...
    Set CrxRep = CrxApp.OpenReport(App.Path & "\reports\PayrollRegister.rpt")
    Set crxDatabase = CrxRep.Database
    Set crxDatabaseTables = crxDatabase.Tables
    
    If optDetailed.Value = True Then
        mReportType = "Detailed"
    ElseIf optCostCenterSum.Value = True Then
        mReportType = "CostCenter"
    ElseIf optDivisionSum.Value = True Then
        mReportType = "Division"
    End If
    ...
    CrxRep.ParameterFields.GetItemByName("mReportType").AddCurrentValue mReportType
...
Private Sub optCostCenterSum_Click()
    If optCostCenterSum.Value = True Then
        tdbDivision.Enabled = True
        tdbCostCenter.Enabled = True
...
Private Sub optDetailed_Click()
    If optDetailed.Value = True Then
        tdbDivision.Enabled = True
        tdbCostCenter.Enabled = True
        tdbEmployee.Enabled = True
    End If
End Sub

Private Sub optDivisionSum_Click()
    If optDivisionSum.Value = True Then
        tdbDivision.Enabled = True
        tdbCostCenter.Enabled = False
        tdbEmployee.Enabled = False
    End If
End Sub
