...
Begin VB.Form frmRepLoandedAsof 
   ...
   Begin VB.Frame Fra1 
      ...
      Begin VB.CommandButton cmdGen 
         ...
         Width           =   2145
      End
      Begin TDBDate6Ctl.TDBDate tdbGenDate 
         Height          =   330
         Left            =   6585
         TabIndex        =   2
         Top             =   195
         ...
         _ExtentX        =   2937
         _ExtentY        =   582
         Calendar        =   "frmRepLoandedAsof.frx":0000
         Caption         =   "frmRepLoandedAsof.frx":0118
         ...
         EndProperty
         DropDown        =   "frmRepLoandedAsof.frx":0184
         Keys            =   "frmRepLoandedAsof.frx":01A2
         Spin            =   "frmRepLoandedAsof.frx":0200
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   0
      ...
      Begin TrueOleDBList80.TDBCombo tdbLoanTypes 
         ...
         RowDividerStyle =   0
         Caption         =   ""
         EditFont        =   "Size=9,Charset=0,Weight=400,Underline=0,Italic=0,Strikethrough=0,Name=Verdana"
         LayoutName      =   ""
         LayoutFileName  =   ""
         MultipleLines   =   0
         EmptyRows       =   -1  'True
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRepLoandedAsof.frx":0228
   ...
   End
End
Attribute VB_Name = "frmRepLoandedAsof"
