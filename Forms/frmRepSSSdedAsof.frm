...
Begin VB.Form frmRepSSSdedAsof 
   Caption         =   "SSS Deductions"
   ClientHeight    =   7410
   ClientLeft      =   60
   ClientTop       =   390
   ClientWidth     =   10905
   ...
   Begin VB.Frame Fra1 
      ...
      Begin TrueOleDBList80.TDBCombo tdbPercode1 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRepSSSdedAsof.frx":0000
      ...
      Begin TrueOleDBList80.TDBCombo tdbPercode2 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRepSSSdedAsof.frx":00AA
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
   ...
   End
End
Attribute VB_Name = "frmRepSSSdedAsof"
