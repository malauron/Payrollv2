...
Begin VB.Form frmRptPhilHealthContribution 
   ClientHeight    =   8130
   ClientLeft      =   60
   ClientTop       =   60
   ClientWidth     =   10035
   ...
   Begin VB.Frame fraParmtr 
      ...
      Top             =   495
      Width           =   3465
      Begin VB.Frame frmDisplayOptions 
         BackColor       =   &H00F6F8F8&
         ...
         Top             =   4260
         Width           =   3225
         Begin VB.OptionButton optSepName 
            Appearance      =   0  'Flat
            BackColor       =   &H00F6F8F8&
            Caption         =   "First, middle and last name in separate columns"
            BeginProperty Font 
               Name            =   "Tahoma"
               Size            =   8.25
               Charset         =   0
         ...
         Begin VB.OptionButton optFullname 
            Appearance      =   0  'Flat
            BackColor       =   &H00F6F8F8&
            Caption         =   "Fullname in one column"
            BeginProperty Font 
               Name            =   "Tahoma"
               Size            =   8.25
               Charset         =   0
      ...
      Begin TrueOleDBList80.TDBCombo tdbMonth 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptHDMFContribution.frx":0000
      ...
      Begin OsenXPCntrl.OsenXPButton cmdView 
         ...
         MCOL            =   12632256
         MPTR            =   0
         MICON           =   "frmRptHDMFContribution.frx":00AA
         PICN            =   "frmRptHDMFContribution.frx":00C6
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin TDBNumber6Ctl.TDBNumber txtPayYear 
         ...
         _ExtentX        =   2646
         _ExtentY        =   556
         Calculator      =   "frmRptHDMFContribution.frx":0660
         Caption         =   "frmRptHDMFContribution.frx":0680
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmRptHDMFContribution.frx":06E6
         Keys            =   "frmRptHDMFContribution.frx":0704
         Spin            =   "frmRptHDMFContribution.frx":074E
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   0
      ...
      Begin TrueOleDBList80.TDBCombo tdbEmployee 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptHDMFContribution.frx":0776
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin TrueOleDBList80.TDBCombo tdbCostCenter 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptHDMFContribution.frx":0820
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin TrueOleDBList80.TDBCombo tdbDivision 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptHDMFContribution.frx":08CA
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
   ...
   End
End
Attribute VB_Name = "frmRptPhilHealthContribution"
...
Private Sub cmdView_Click()
    ...
    If optFullname.Value = True Then
    ...
    Else
      If optEmployee.Value = True Then
          Set CrxRep = CrxApp.OpenReport(App.Path & "\reports\PhilHealthContributionSepName.rpt")
      Else
          Set CrxRep = CrxApp.OpenReport(App.Path & "\reports\PhilHealthContributionGroupedSepName.rpt")
      End If
    End If
