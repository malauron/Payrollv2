...
Begin VB.Form frmRptLeaveApplications 
   ClientHeight    =   8160
   ClientLeft      =   60
   ClientTop       =   60
   ClientWidth     =   10485
   ...
   Begin VB.Frame fraParmtr 
      ...
      Begin TrueOleDBList80.TDBCombo tdbPayrollPeriod 
         ...
         Splits(0)._ColumnProps(7)=   "Column(1).Width=2302"
         Splits(0)._ColumnProps(8)=   "Column(1).DividerColor=0"
         Splits(0)._ColumnProps(9)=   "Column(1)._WidthInPix=2223"
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptLeaveApplications.frx":0000
      ...
      Begin TrueOleDBList80.TDBCombo tdbEmployee 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptLeaveApplications.frx":00AA
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin OsenXPCntrl.OsenXPButton cmdView 
         ...
         MCOL            =   12632256
         MPTR            =   0
         MICON           =   "frmRptLeaveApplications.frx":0154
         PICN            =   "frmRptLeaveApplications.frx":0170
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin TrueOleDBList80.TDBCombo tdbCostCenter 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptLeaveApplications.frx":070A
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin TrueOleDBList80.TDBCombo tdbDivision 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptLeaveApplications.frx":07B4
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
   ...
   Begin LinkProPayroll.b8ChildTitleBar TitleBar 
      ...
      _ExtentX        =   5159
      _ExtentY        =   609
      Caption         =   "Leave Availment Report"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmRptLeaveApplications"
...
Private Sub cmdView_Click()
    ...
    Set CrxRep = CrxApp.OpenReport(App.Path & "\reports\LeaveApplications.rpt")
...
'    End If
    ...
    CrxRep.ParameterFields.GetItemByName("mDate1").AddCurrentValue CDate(Format(tdbPayrollPeriod.Columns("wrkdatefrom").Text, "MM/DD/YYYY"))
    CrxRep.ParameterFields.GetItemByName("mDate2").AddCurrentValue CDate(Format(tdbPayrollPeriod.Columns("wrkdateto").Text, "MM/DD/YYYY"))
    CrxRep.ParameterFields.GetItemByName("mPercode").AddCurrentValue CInt(tdbPayrollPeriod.BoundText)
