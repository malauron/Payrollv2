...
Begin VB.Form frmRptLoanCollection 
   ClientHeight    =   8295
   ClientLeft      =   60
   ClientTop       =   60
   ClientWidth     =   9330
   ...
   Begin VB.Frame fraParmtr 
      ...
      Begin VB.Frame Frame1 
         ...
         Top             =   45
         Width           =   3225
         Begin VB.OptionButton optCostcenter 
            Appearance      =   0  'Flat
            BackColor       =   &H00F6F8F8&
            Caption         =   "Group By Costcenter"
            BeginProperty Font 
               Name            =   "Tahoma"
               Size            =   8.25
               Charset         =   0
         ...
         Begin VB.OptionButton optDivision 
            ...
            Width           =   2595
         End
         Begin VB.OptionButton optLoanTypes 
            Appearance      =   0  'Flat
            BackColor       =   &H00F6F8F8&
            Caption         =   "Group By Loan Types"
            BeginProperty Font 
               Name            =   "Tahoma"
               Size            =   8.25
               Charset         =   0
      ...
      Begin TrueOleDBList80.TDBCombo tdbMonth 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptLoanCollection.frx":0000
      ...
      Begin OsenXPCntrl.OsenXPButton cmdView 
         ...
         MCOL            =   12632256
         MPTR            =   0
         MICON           =   "frmRptLoanCollection.frx":00AA
         PICN            =   "frmRptLoanCollection.frx":00C6
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin TDBNumber6Ctl.TDBNumber txtPayYear 
         ...
         _ExtentX        =   2646
         _ExtentY        =   556
         Calculator      =   "frmRptLoanCollection.frx":0660
         Caption         =   "frmRptLoanCollection.frx":0680
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmRptLoanCollection.frx":06E6
         Keys            =   "frmRptLoanCollection.frx":0704
         Spin            =   "frmRptLoanCollection.frx":074E
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   0
      ...
      Begin TrueOleDBList80.TDBCombo tdbLoanTypes 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptLoanCollection.frx":0776
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin TrueOleDBList80.TDBCombo tdbDivision 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptLoanCollection.frx":0820
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin TrueOleDBList80.TDBCombo tdbCostCenter 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptLoanCollection.frx":08CA
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
   ...
   End
End
Attribute VB_Name = "frmRptLoanCollection"
...
Private Sub cmdView_Click()
    ...
    If optEmployee.Value = True Then
        Set CrxRep = CrxApp.OpenReport(App.Path & "\reports\LoanCollections.rpt")
    ElseIf optLoanTypes.Value = True Then
        Set CrxRep = CrxApp.OpenReport(App.Path & "\reports\LoanCollectionsGrouped.rpt")
    ElseIf optDivision.Value = True Then
        Set CrxRep = CrxApp.OpenReport(App.Path & "\reports\LoanCollectionsDivision.rpt")
'        If Trim(tdbDivision.Text) <> "" And Not IsNull(tdbDivision.SelectedItem) And tdbDivision.ApproxCount > 0 Then
'          mAddQuery2 = " where e.divisioncode = " & tdbDivision.BoundText & " "
'        End If
    ElseIf optCostcenter.Value = True Then
        Set CrxRep = CrxApp.OpenReport(App.Path & "\reports\LoanCollectionsCostcenter.rpt")
'        If Trim(tdbDivision.Text) <> "" And Not IsNull(tdbDivision.SelectedItem) And tdbDivision.ApproxCount > 0 Then
'          mAddQuery2 = " where e.divisioncode = " & tdbDivision.BoundText & " "
'          If Trim(tdbCostCenter.Text) <> "" And Not IsNull(tdbCostCenter.SelectedItem) And tdbCostCenter.ApproxCount > 0 Then
'            mAddQuery2 = mAddQuery2 & " and f.costcentercode = " & tdbCostCenter.BoundText & " "
'          End If
'        End If
    End If
    ...
    If Trim(tdbLoanTypes.Text) <> "" And Not IsNull(tdbLoanTypes.SelectedItem) And tdbLoanTypes.ApproxCount > 0 Then
        If Not optLoanTypes.Value = True Then
            CrxRep.ParameterFields.GetItemByName("mLoanType").AddCurrentValue tdbLoanTypes.Text
        End If
        mAddQuery = " and loantypescode = " & tdbLoanTypes.BoundText & " "
    Else
        If Not optLoanTypes.Value = True Then
            CrxRep.ParameterFields.GetItemByName("mLoanType").AddCurrentValue ""
        End If
    End If
    
    If Trim(tdbDivision.Text) <> "" And Not IsNull(tdbDivision.SelectedItem) And tdbDivision.ApproxCount > 0 Then
      mAddQuery2 = " where b.divisioncode = " & tdbDivision.BoundText & " "
      If Trim(tdbCostCenter.Text) <> "" And Not IsNull(tdbCostCenter.SelectedItem) And tdbCostCenter.ApproxCount > 0 Then
        mAddQuery2 = mAddQuery2 & " and b.costcentercode = " & tdbCostCenter.BoundText & " "
      End If
    End If
    
    CrxRep.ParameterFields.GetItemByName("mAddQuery").AddCurrentValue mAddQuery
    CrxRep.ParameterFields.GetItemByName("mAddQuery2").AddCurrentValue mAddQuery2
...
Private Sub tdbLoanTypes_GotFocus()
    ...
    If Trim(tdbLoanTypes.Text) <> "" And Not IsNull(tdbLoanTypes.SelectedItem) And tdbLoanTypes.ApproxCount > 0 Then
        tdbLoanTypes.Tag = tdbLoanTypes.BoundText
    Else
        tdbLoanTypes.Tag = ""
    End If
    ...
    tdbLoanTypes.BoundText = tdbLoanTypes.Tag
    tdbLoanTypes.Tag = ""
