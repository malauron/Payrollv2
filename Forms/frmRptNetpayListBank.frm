...
Begin VB.Form frmRptNetpayListBank 
   BackColor       =   &H00F6F8F8&
   ClientHeight    =   8220
   ClientLeft      =   60
   ClientTop       =   60
   ...
   Begin VB.Frame fraParmtr 
      ...
      Begin TrueOleDBList80.TDBCombo tdbPayrollPeriod 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptNetpayListBank.frx":0000
      ...
      Begin TrueOleDBList80.TDBCombo tdbEmployee 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptNetpayListBank.frx":00AA
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin OsenXPCntrl.OsenXPButton cmdView 
         ...
         MCOL            =   12632256
         MPTR            =   0
         MICON           =   "frmRptNetpayListBank.frx":0154
         PICN            =   "frmRptNetpayListBank.frx":0170
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin TrueOleDBList80.TDBCombo tdbSection 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptNetpayListBank.frx":070A
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin TrueOleDBList80.TDBCombo tdbBank 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptNetpayListBank.frx":07B4
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin TrueOleDBList80.TDBCombo tdbCostCenter 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptNetpayListBank.frx":085E
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin TrueOleDBList80.TDBCombo tdbDivision 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptNetpayListBank.frx":0908
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
   ...
   End
End
Attribute VB_Name = "frmRptNetpayListBank"
...
Private Sub cmdView_Click()
    ...
    Dim mTtlRec             As Integer
    Dim mNotInc             As Integer
    Dim mNegative           As Integer
    
    Dim mNotIncAmnt         As Double
    ...
    Set CrxRep = CrxApp.OpenReport(App.Path & "\reports\NetPayListBank201904221103.rpt")
    ...
    NetOpen rs, "select count(employeecode) recctr from payroll where percode = " & tdbPayrollPeriod.BoundText & ""
    
    If rs.RecordCount > 0 Then
        If Not IsNull(rs!recctr) Then
            mTtlRec = rs!recctr
        End If
    End If
    
    NetOpen rs, "select count(employeecode) recctr,sum(net) ttlnetpay from payroll where percode = " & tdbPayrollPeriod.BoundText & " and saltobank = 'N'"
    
    If rs.RecordCount > 0 Then
        If Not IsNull(rs!recctr) Then
            mNotInc = rs!recctr
        End If
        If Not IsNull(rs!ttlnetpay) Then
            mNotIncAmnt = rs!ttlnetpay
        End If
    End If
    
    NetOpen rs, "select count(employeecode) recctr from payroll where percode = " & tdbPayrollPeriod.BoundText & " and net < 0"
    ...
    If Trim(tdbDivision.Text) <> "" And Not IsNull(tdbDivision.SelectedItem) And tdbDivision.ApproxCount <> 0 And tdbDivision.Enabled = True Then
        If Trim(tdbCostCenter.Text) <> "" And Not IsNull(tdbCostCenter.SelectedItem) And tdbCostCenter.ApproxCount <> 0 And tdbCostCenter.Enabled = True Then
            If Trim(tdbEmployee.Text) <> "" And Not IsNull(tdbEmployee.SelectedItem) And tdbCostCenter.ApproxCount <> 0 And tdbEmployee.Enabled = True Then
    ...
    CrxRep.ParameterFields.GetItemByName("mPeriod").AddCurrentValue tdbPayrollPeriod.Text
    CrxRep.ParameterFields.GetItemByName("mTtlRec").AddCurrentValue mTtlRec
    CrxRep.ParameterFields.GetItemByName("mNotInc").AddCurrentValue mNotInc
    CrxRep.ParameterFields.GetItemByName("mNegative").AddCurrentValue mNegative
    CrxRep.ParameterFields.GetItemByName("mNotIncAmnt").AddCurrentValue mNotIncAmnt
    CrxRep.ParameterFields.GetItemByName("mBankCode").AddCurrentValue CInt(tdbBank.BoundText)
    CrxRep.ParameterFields.GetItemByName("mBankName").AddCurrentValue tdbBank.Text
...
Private Sub tdbBank_GotFocus()
  tdbBank.SelStart = 0
  tdbBank.SelLength = Len(tdbBank.Text)
End Sub
...
'
'        If IsNull(tdbEmployee.SelectedItem) Or tdbEmployee.ApproxCount <= 0 Then
...
Private Sub tdbDivision_GotFocus()
    ...
    bind_tdb ConMain, tdbDivision, "select divisioncode,division from division order by division", "division", "divisioncode"
