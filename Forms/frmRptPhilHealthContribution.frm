...
Begin VB.Form frmRptHDMFContribution 
   ClientHeight    =   8130
   ClientLeft      =   60
   ClientTop       =   60
   ClientWidth     =   10035
   ...
   End
End
Attribute VB_Name = "frmRptHDMFContribution"
...
Private Sub cmdView_Click()
    ...
    If ListView1.ListItems.count > 0 Then
      For i = 1 To ListView1.ListItems.count
        If ListView1.ListItems(i).Checked = True Then
          If Trim(mDivisionCode) = "" Then
            mDivisionCode = ListView1.ListItems(i).SubItems(1)
          Else
            mDivisionCode = mDivisionCode & "," & ListView1.ListItems(i).SubItems(1)
          End If
        End If
      Next
      If Trim(mDivisionCode) = "" Then
          MsgBox "Please select a cost center."
          Exit Sub
        End If
    ...
    CrxRep.ParameterFields.GetItemByName("mDivisionCode").AddCurrentValue mDivisionCode
...
Private Sub Form_Load()
    ...
    NetOpen rsDivision, "select divisioncode,division from division order by division"
    ...
    If rsDivision.RecordCount > 0 Then
      ...
      Me.ListView1.ColumnHeaders.Add , , "Description", ListView1.Width - 400 'VListView1.Width / 2
      Me.ListView1.ColumnHeaders.Add , , "Descriptions", 0 'ListView1.Width / 2
  
      With Me.ListView1.ListItems
        Do While Not rsDivision.EOF
          .Add , , rsDivision!Division
          .Item(rsDivision.AbsolutePosition).Checked = True
          Me.ListView1.ListItems(rsDivision.AbsolutePosition).SubItems(1) = rsDivision!divisioncode
          rsDivision.MoveNext
        Loop
