...
Begin VB.Form frmRptSSSContribution 
   ClientHeight    =   9255
   ClientLeft      =   60
   ClientTop       =   60
   ClientWidth     =   12120
   ...
   Begin VB.Frame fraParmtr 
      ...
      Begin TrueOleDBList80.TDBCombo tdbMonth 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptSSSContribution.frx":0000
      ...
      Begin OsenXPCntrl.OsenXPButton cmdView 
         ...
         MCOL            =   12632256
         MPTR            =   0
         MICON           =   "frmRptSSSContribution.frx":00AA
         PICN            =   "frmRptSSSContribution.frx":00C6
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin TDBNumber6Ctl.TDBNumber txtPayYear 
         ...
         _ExtentX        =   2646
         _ExtentY        =   556
         Calculator      =   "frmRptSSSContribution.frx":0660
         Caption         =   "frmRptSSSContribution.frx":0680
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmRptSSSContribution.frx":06E6
         Keys            =   "frmRptSSSContribution.frx":0704
         Spin            =   "frmRptSSSContribution.frx":074E
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   0
      ...
      Begin TrueOleDBList80.TDBCombo tdbEmployee 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptSSSContribution.frx":0776
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin TrueOleDBList80.TDBCombo tdbCostCenter 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptSSSContribution.frx":0820
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      Begin TrueOleDBList80.TDBCombo tdbDivision 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptSSSContribution.frx":08CA
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
   ...
   End
End
Attribute VB_Name = "frmRptSSSContribution"
...
'        If CInt(tdbMonth.BoundText) <= 3 And CInt(txtPayYear.Text) <= 2018 Then
          Set CrxRep = CrxApp.OpenReport(App.Path & "\reports\SSSContribution.rpt")
'        ElseIf (CInt(tdbMonth.BoundText) >= 4 And CInt(txtPayYear.Text) >= 2018) And _
'         (CInt(tdbMonth.BoundText) <= 3 And CInt(txtPayYear.Text) <= 2019) Then
'          Set CrxRep = CrxApp.OpenReport(App.Path & "\reports\SSSContribution201805.rpt")
'        Else
'          Set CrxRep = CrxApp.OpenReport(App.Path & "\reports\SSSContribution201904.rpt")
'        End If
    Else
'        If CInt(tdbMonth.BoundText) <= 3 And CInt(txtPayYear.Text) <= 2018 Then
          Set CrxRep = CrxApp.OpenReport(App.Path & "\reports\SSSContributionGrouped.rpt")
'        ElseIf (CInt(tdbMonth.BoundText) >= 4 And CInt(txtPayYear.Text) >= 2018) And _
'         (CInt(tdbMonth.BoundText) <= 3 And CInt(txtPayYear.Text) <= 2019) Then
'          Set CrxRep = CrxApp.OpenReport(App.Path & "\reports\SSSContributionGrouped201805.rpt")
'        Else
'          Set CrxRep = CrxApp.OpenReport(App.Path & "\reports\SSSContributionGrouped201904.rpt")
'        End If
    End If
    ...
    If Trim(tdbDivision.Text) <> "" And Not IsNull(tdbDivision.SelectedItem) And tdbDivision.ApproxCount <> 0 Then
        If Trim(tdbCostCenter.Text) <> "" And Not IsNull(tdbCostCenter.SelectedItem) And tdbCostCenter.ApproxCount <> 0 Then
            If Trim(tdbEmployee.Text) <> "" And Not IsNull(tdbEmployee.SelectedItem) And tdbCostCenter.ApproxCount <> 0 Then
                mAddQuery = "and employeecode = '" & tdbEmployee.BoundText & "'"
            Else
