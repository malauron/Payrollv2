...
Begin VB.Form frmRptWithHoldingsTaxContribution 
   ClientHeight    =   7545
   ClientLeft      =   60
   ClientTop       =   60
   ClientWidth     =   11025
   ...
   Begin VB.Frame fraParmtr 
      ...
      Begin TrueOleDBList80.TDBCombo tdbMonth 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmRptWithHoldingsTaxContribution.frx":0000
      ...
      Begin OsenXPCntrl.OsenXPButton cmdView 
         ...
         MCOL            =   12632256
         MPTR            =   0
         MICON           =   "frmRptWithHoldingsTaxContribution.frx":00AA
         PICN            =   "frmRptWithHoldingsTaxContribution.frx":00C6
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin TDBNumber6Ctl.TDBNumber txtPayYear 
         ...
         _ExtentX        =   2646
         _ExtentY        =   556
         Calculator      =   "frmRptWithHoldingsTaxContribution.frx":0660
         Caption         =   "frmRptWithHoldingsTaxContribution.frx":0680
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Verdana"
            Size            =   8.25
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "frmRptWithHoldingsTaxContribution.frx":06E6
         Keys            =   "frmRptWithHoldingsTaxContribution.frx":0704
         Spin            =   "frmRptWithHoldingsTaxContribution.frx":074E
         AlignHorizontal =   1
         AlignVertical   =   0
         Appearance      =   0
   ...
   Begin LinkProPayroll.b8ChildTitleBar TitleBar 
      ...
      _ExtentX        =   4604
      _ExtentY        =   609
      Caption         =   "Withholding TaxContribution"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmRptWithHoldingsTaxContribution"
...
Private Sub cmdView_Click()
    ...
    Set CrxRep = CrxApp.OpenReport(App.Path & "\reports\WithHoldingTaxContribution.rpt")
