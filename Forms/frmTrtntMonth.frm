...
Begin VB.Form frmTrtntMonth 
   ...
   Begin VB.Frame Fra1 
      ...
      Begin TrueOleDBList80.TDBCombo tdbPercode1 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmTrtntMonth.frx":0000
      ...
      Begin TrueOleDBList80.TDBCombo tdbPercode2 
         ...
         MaxComboItems   =   10
         AddItemSeparator=   ";"
         _PropDict       =   $"frmTrtntMonth.frx":00AA
         _StyleDefs(0)   =   "_StyleRoot:id=0,.parent=-1,.alignment=3,.valignment=0,.bgcolor=&H80000005&"
         _StyleDefs(1)   =   ":id=0,.fgcolor=&H80000008&,.wraptext=0,.locked=0,.transparentBmp=0"
         _StyleDefs(2)   =   ":id=0,.fgpicPosition=0,.bgpicMode=0,.appearance=0,.borderSize=0,.ellipsis=0"
         _StyleDefs(3)   =   ":id=0,.borderColor=&H80000005&,.borderType=0,.bold=0,.fontsize=825,.italic=0"
      ...
      End
   End
   Begin TrueOleDBGrid80.TDBGrid tdgTmonth 
      Height          =   7995
      Left            =   135
      TabIndex        =   0
      Top             =   180
      ...
      Columns(0)._VlistStyle=   0
      Columns(0)._MaxComboItems=   5
      Columns(0).Caption=   "Row Number"
      Columns(0).DataField=   "ctr"
      Columns(0)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(1)._VlistStyle=   0
      Columns(1)._MaxComboItems=   5
      Columns(1).Caption=   "Employee number"
      Columns(1).DataField=   "empno"
      Columns(1)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      ...
      Columns(3).Caption=   "Add Ons"
      Columns(3).DataField=   "addon"
      Columns(3).NumberFormat=   "#,##0.00"
      Columns(3).ExternalEditor=   "txtAmnt"
      Columns(3).ExternalEditor.vt=   8
      Columns(3)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(4)._VlistStyle=   0
      Columns(4)._MaxComboItems=   5
      Columns(4).Caption=   "Total Basic"
      Columns(4).DataField=   "trtntbasic"
      Columns(4).NumberFormat=   "#,##0.00"
      Columns(4)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(5)._VlistStyle=   0
      Columns(5)._MaxComboItems=   5
      Columns(5).Caption=   "13 Month Pay"
      Columns(5).DataField=   "trtntmonth"
      ...
      Splits(0)._ColumnProps(13)=   "Column(2).Width=8334"
      Splits(0)._ColumnProps(14)=   "Column(2).DividerColor=0"
      Splits(0)._ColumnProps(15)=   "Column(2)._WidthInPix=8229"
      ...
      Splits(0)._ColumnProps(29)=   "Column(4)._ColStyle=8194"
      ...
      PrintInfos(0).PageHeaderFont=   "Size=9,Charset=0,Weight=400,Underline=0,Italic=0,Strikethrough=0,Name=Verdana"
      PrintInfos(0).PageFooterFont=   "Size=9,Charset=0,Weight=400,Underline=0,Italic=0,Strikethrough=0,Name=Verdana"
      ...
      _StyleDefs(16)  =   "EvenRowStyle:id=9,.parent=1,.namedParent=39,.bgcolor=&HD7F9FD&"
      _StyleDefs(17)  =   "OddRowStyle:id=10,.parent=1,.namedParent=33"
      _StyleDefs(18)  =   "RecordSelectorStyle:id=11,.parent=2,.namedParent=41"
      _StyleDefs(19)  =   "FilterBarStyle:id=12,.parent=1,.namedParent=42"
      _StyleDefs(20)  =   "Splits(0).Style:id=13,.parent=1"
      _StyleDefs(21)  =   "Splits(0).CaptionStyle:id=22,.parent=4"
      ...
      _StyleDefs(30)  =   "Splits(0).RecordSelectorStyle:id=23,.parent=11"
      _StyleDefs(31)  =   "Splits(0).FilterBarStyle:id=24,.parent=12"
      _StyleDefs(32)  =   "Splits(0).Columns(0).Style:id=50,.parent=13,.locked=-1"
      ...
      _StyleDefs(36)  =   "Splits(0).Columns(1).Style:id=46,.parent=13,.locked=-1"
      ...
      _StyleDefs(40)  =   "Splits(0).Columns(2).Style:id=32,.parent=13,.locked=-1"
      ...
      _StyleDefs(44)  =   "Splits(0).Columns(3).Style:id=28,.parent=13,.alignment=1"
      ...
      _StyleDefs(48)  =   "Splits(0).Columns(4).Style:id=54,.parent=13,.alignment=1,.locked=-1"
      ...
      _StyleDefs(52)  =   "Splits(0).Columns(5).Style:id=58,.parent=13,.alignment=1,.locked=-1"
   ...
   End
End
Attribute VB_Name = "frmTrtntMonth"
